 ...
 * TO- timeout, LF-learning failure 
 */ 
...
/* Rule triggered by CW1 executions initiated
 * by the STUDENT and completed either in success, learning failure or 
 * timeout.
 */
RULE(CW1){
 printf("CW1 ");
 ...
 * by the STUDENT and completed either in success, 
 * learning failure or timeout.
 */
RULE(CW2){
 printf("CW2 ");

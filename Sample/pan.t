...
{	Trans *T;
	...
	T = trans[ 2][3] = settr(1592,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1592,2,1,0,0,"ATOMIC", 0, 2, 0);
	trans[2][1]	= settr(1590,2,2,3,3,"(run LEG())", 0, 2, 0);
	trans[2][2]	= settr(1591,0,4,4,4,"(run CRM())", 0, 2, 0);
	trans[2][4]	= settr(1593,0,0,5,5,"-end-", 0, 3500, 0);

	/* proctype 1: CRM */

	trans[1] = (Trans **) emalloc(735*sizeof(Trans *));

	trans[1][1]	= settr(856,0,731,6,0,"printf('CONTRACT RULE MANAGER')", 0, 2, 0);
	trans[1][732]	= settr(1587,0,731,1,0,".(goto)", 0, 2, 0);
	T = trans[1][731] = settr(1586,0,0,0,0,"DO", 0, 2, 0);
	T = T->nxt	= settr(1586,0,12,0,0,"DO", 0, 2, 0);
	T = T->nxt	= settr(1586,0,78,0,0,"DO", 0, 2, 0);
	T = T->nxt	= settr(1586,0,159,0,0,"DO", 0, 2, 0);
	T = T->nxt	= settr(1586,0,247,0,0,"DO", 0, 2, 0);
	T = T->nxt	= settr(1586,0,335,0,0,"DO", 0, 2, 0);
	T = T->nxt	= settr(1586,0,423,0,0,"DO", 0, 2, 0);
	    T->nxt	= settr(1586,0,495,0,0,"DO", 0, 2, 0);
	T = trans[ 1][12] = settr(867,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(867,0,10,0,0,"sub-sequence", 0, 2, 0);
	T = trans[1][10] = settr(865,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(865,0,2,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(865,0,4,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(865,0,6,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(865,0,8,0,0,"IF", 0, 2, 0);
	trans[1][2]	= settr(857,0,3,7,0,"(LEG2CRM?[18,S])", 1, 2, 0);
	trans[1][3]	= settr(858,0,67,8,8,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][11]	= settr(866,0,67,1,0,".(goto)", 0, 2, 0);
	trans[1][4]	= settr(859,0,5,9,0,"(LEG2CRM?[18,TO])", 1, 2, 0);
	trans[1][5]	= settr(860,0,67,10,10,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][6]	= settr(861,0,7,11,0,"(LEG2CRM?[18,TF])", 1, 2, 0);
	trans[1][7]	= settr(862,0,67,12,12,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][8]	= settr(863,0,9,13,0,"(LEG2CRM?[18,LF])", 1, 2, 0);
	trans[1][9]	= settr(864,0,67,14,14,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][67] = settr(922,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(922,0,13,0,0,"sub-sequence", 0, 2, 0);
	trans[1][13]	= settr(868,0,65,15,15,"printf('Start\\n')", 0, 2, 0); /* m: 14 -> 0,65 */
	reached1[14] = 1;
	trans[1][14]	= settr(0,0,0,0,0,"printf('Registration Request by Student')",0,0,0);
	T = trans[1][65] = settr(920,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(920,0,15,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(920,0,35,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(920,0,62,0,0,"IF", 0, 2, 0);
	trans[1][15]	= settr(870,0,34,16,0,"((((RegReq_bo.right==1)&&((RegReq_bo.role_pl==STUDENT)==1))&&((RegReq_bo.status==S)==1)))", 1, 2, 0);
	T = trans[ 1][34] = settr(889,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(889,0,16,0,0,"sub-sequence", 0, 2, 0);
	trans[1][16]	= settr(871,0,23,17,17,"STUDENTexTrace = (STUDENTexTrace|(1<<RegReq_bo.id))", 1, 2, 0);
	T = trans[ 1][23] = settr(878,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(878,2,17,0,0,"ATOMIC", 0, 2, 0);
	trans[1][17]	= settr(872,4,27,18,18,"printf('\\n\\n')", 0, 2, 0); /* m: 18 -> 0,27 */
	reached1[18] = 1;
	...
	T = trans[ 1][27] = settr(882,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(882,0,24,0,0,"sub-sequence", 0, 2, 0);
	trans[1][24]	= settr(879,0,25,19,19,"RegReply_bo.oblig = 1", 1, 2, 0);
	trans[1][25]	= settr(880,0,26,20,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.prohib==1))))", 1, 2, 0);
	trans[1][26]	= settr(881,0,31,21,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][31] = settr(886,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(886,0,28,0,0,"sub-sequence", 0, 2, 0);
	trans[1][28]	= settr(883,0,29,22,22,"RegReq_bo.right = 0", 1, 2, 0);
	trans[1][29]	= settr(884,0,30,23,0,"assert(!(((RegReq_bo.right==1)&&(RegReq_bo.oblig==1))))", 1, 2, 0);
	trans[1][30]	= settr(885,0,33,24,0,"assert(!(((RegReq_bo.right==1)&&(RegReq_bo.prohib==1))))", 1, 2, 0);
	T = trans[ 1][33] = settr(888,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(888,0,32,0,0,"sub-sequence", 0, 2, 0);
	trans[1][32]	= settr(887,0,731,25,25,"CRM2LEG!9,5", 1, 4, 0);
	trans[1][66]	= settr(921,0,731,1,0,".(goto)", 0, 2, 0);
	trans[1][35]	= settr(890,0,61,26,0,"((((RegReq_bo.right==1)&&((RegReq_bo.role_pl==STUDENT)==1))&&((RegReq_bo.status==TF)==1)))", 1, 2, 0);
	T = trans[ 1][61] = settr(916,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(916,0,42,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][42] = settr(897,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(897,2,36,0,0,"ATOMIC", 0, 2, 0);
	trans[1][36]	= settr(891,0,47,27,27,"printf('\\n\\n')", 0, 2, 0); /* m: 37 -> 0,47 */
	reached1[37] = 1;
	...
	T = trans[ 1][47] = settr(902,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(902,0,44,0,0,"sub-sequence", 0, 2, 0);
	trans[1][44]	= settr(899,0,45,28,28,"RegReply_bo.oblig = 0", 1, 2, 0);
	trans[1][45]	= settr(900,0,46,29,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.prohib==1))))", 1, 2, 0);
	trans[1][46]	= settr(901,0,51,30,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][51] = settr(906,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(906,0,48,0,0,"sub-sequence", 0, 2, 0);
	trans[1][48]	= settr(903,0,49,31,31,"RegReq_bo.right = 1", 1, 2, 0);
	trans[1][49]	= settr(904,0,50,32,0,"assert(!(((RegReq_bo.right==1)&&(RegReq_bo.oblig==1))))", 1, 2, 0);
	trans[1][50]	= settr(905,0,58,33,0,"assert(!(((RegReq_bo.right==1)&&(RegReq_bo.prohib==1))))", 1, 2, 0);
	T = trans[ 1][58] = settr(913,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(913,2,52,0,0,"ATOMIC", 0, 2, 0);
	trans[1][52]	= settr(907,4,60,34,34,"printf('\\n\\n')", 0, 2, 0); /* m: 53 -> 0,60 */
	reached1[53] = 1;
	...
	T = trans[ 1][60] = settr(915,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(915,0,59,0,0,"sub-sequence", 0, 2, 0);
	trans[1][59]	= settr(914,0,731,35,35,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][62]	= settr(917,0,64,2,0,"else", 0, 2, 0);
	T = trans[ 1][64] = settr(919,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(919,0,63,0,0,"sub-sequence", 0, 2, 0);
	trans[1][63]	= settr(918,0,731,36,36,"CRM2LEG!6,5", 1, 4, 0);
	T = trans[ 1][78] = settr(933,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(933,0,76,0,0,"sub-sequence", 0, 2, 0);
	T = trans[1][76] = settr(931,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(931,0,68,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(931,0,70,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(931,0,72,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(931,0,74,0,0,"IF", 0, 2, 0);
	trans[1][68]	= settr(923,0,69,37,0,"(LEG2CRM?[19,S])", 1, 2, 0);
	trans[1][69]	= settr(924,0,148,38,38,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][77]	= settr(932,0,148,1,0,".(goto)", 0, 2, 0);
	trans[1][70]	= settr(925,0,71,39,0,"(LEG2CRM?[19,TO])", 1, 2, 0);
	trans[1][71]	= settr(926,0,148,40,40,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][72]	= settr(927,0,73,41,0,"(LEG2CRM?[19,TF])", 1, 2, 0);
	trans[1][73]	= settr(928,0,148,42,42,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][74]	= settr(929,0,75,43,0,"(LEG2CRM?[19,LF])", 1, 2, 0);
	trans[1][75]	= settr(930,0,148,44,44,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][148] = settr(1003,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1003,0,79,0,0,"sub-sequence", 0, 2, 0);
	trans[1][79]	= settr(934,0,146,45,0,"printf('Course list reply')", 0, 2, 0);
	T = trans[1][146] = settr(1001,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1001,0,80,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1001,0,108,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1001,0,143,0,0,"IF", 0, 2, 0);
	trans[1][80]	= settr(935,0,107,46,0,"((((RegReply_bo.oblig==1)&&((RegReply_bo.role_pl==LMS)==1))&&((RegReply_bo.status==S)==1)))", 1, 2, 0);
	T = trans[ 1][107] = settr(962,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(962,0,87,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][87] = settr(942,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(942,2,81,0,0,"ATOMIC", 0, 2, 0);
	trans[1][81]	= settr(936,4,88,47,47,"printf('\\n\\n')", 0, 2, 0); /* m: 82 -> 0,88 */
	reached1[82] = 1;
	...
	trans[1][88]	= settr(943,0,92,48,48,"LMSexTrace = (LMSexTrace|(1<<RegReply_bo.id))", 1, 2, 0);
	T = trans[ 1][92] = settr(947,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(947,0,89,0,0,"sub-sequence", 0, 2, 0);
	trans[1][89]	= settr(944,0,90,49,49,"RegReply_bo.oblig = 0", 1, 2, 0);
	trans[1][90]	= settr(945,0,91,50,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.prohib==1))))", 1, 2, 0);
	trans[1][91]	= settr(946,0,96,51,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][96] = settr(951,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(951,0,93,0,0,"sub-sequence", 0, 2, 0);
	trans[1][93]	= settr(948,0,94,52,52,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][94]	= settr(949,0,95,53,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][95]	= settr(950,0,100,54,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][100] = settr(955,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(955,0,97,0,0,"sub-sequence", 0, 2, 0);
	trans[1][97]	= settr(952,0,98,55,55,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][98]	= settr(953,0,99,56,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][99]	= settr(954,0,104,57,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][104] = settr(959,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(959,0,101,0,0,"sub-sequence", 0, 2, 0);
	trans[1][101]	= settr(956,0,102,58,58,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][102]	= settr(957,0,103,59,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][103]	= settr(958,0,106,60,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][106] = settr(961,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(961,0,105,0,0,"sub-sequence", 0, 2, 0);
	trans[1][105]	= settr(960,0,731,61,61,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][147]	= settr(1002,0,731,1,0,".(goto)", 0, 2, 0);
	trans[1][108]	= settr(963,0,142,62,0,"((((RegReply_bo.oblig==1)&&((RegReply_bo.role_pl==LMS)==1))&&((RegReply_bo.status==TF)==1)))", 1, 2, 0);
	T = trans[ 1][142] = settr(997,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(997,0,115,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][115] = settr(970,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(970,2,109,0,0,"ATOMIC", 0, 2, 0);
	trans[1][109]	= settr(964,0,120,63,63,"printf('\\n\\n')", 0, 2, 0); /* m: 110 -> 0,120 */
	reached1[110] = 1;
	...
	T = trans[ 1][120] = settr(975,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(975,0,117,0,0,"sub-sequence", 0, 2, 0);
	trans[1][117]	= settr(972,0,118,64,64,"RegReply_bo.oblig = 1", 1, 2, 0);
	trans[1][118]	= settr(973,0,119,65,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.prohib==1))))", 1, 2, 0);
	trans[1][119]	= settr(974,0,124,66,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][124] = settr(979,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(979,0,121,0,0,"sub-sequence", 0, 2, 0);
	trans[1][121]	= settr(976,0,122,67,67,"C1_bo.oblig = 0", 1, 2, 0);
	trans[1][122]	= settr(977,0,123,68,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][123]	= settr(978,0,128,69,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][128] = settr(983,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(983,0,125,0,0,"sub-sequence", 0, 2, 0);
	trans[1][125]	= settr(980,0,126,70,70,"C2_bo.oblig = 0", 1, 2, 0);
	trans[1][126]	= settr(981,0,127,71,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][127]	= settr(982,0,132,72,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][132] = settr(987,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(987,0,129,0,0,"sub-sequence", 0, 2, 0);
	trans[1][129]	= settr(984,0,130,73,73,"C3_bo.oblig = 0", 1, 2, 0);
	trans[1][130]	= settr(985,0,131,74,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][131]	= settr(986,0,139,75,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][139] = settr(994,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(994,2,133,0,0,"ATOMIC", 0, 2, 0);
	trans[1][133]	= settr(988,4,141,76,76,"printf('\\n\\n')", 0, 2, 0); /* m: 134 -> 0,141 */
	reached1[134] = 1;
	...
	T = trans[ 1][141] = settr(996,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(996,0,140,0,0,"sub-sequence", 0, 2, 0);
	trans[1][140]	= settr(995,0,731,77,77,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][143]	= settr(998,0,145,2,0,"else", 0, 2, 0);
	T = trans[ 1][145] = settr(1000,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1000,0,144,0,0,"sub-sequence", 0, 2, 0);
	trans[1][144]	= settr(999,0,731,78,78,"CRM2LEG!6,5", 1, 4, 0);
	T = trans[ 1][159] = settr(1014,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1014,0,157,0,0,"sub-sequence", 0, 2, 0);
	T = trans[1][157] = settr(1012,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1012,0,149,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1012,0,151,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1012,0,153,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1012,0,155,0,0,"IF", 0, 2, 0);
	trans[1][149]	= settr(1004,0,150,79,0,"(LEG2CRM?[20,S])", 1, 2, 0);
	trans[1][150]	= settr(1005,0,236,80,80,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][158]	= settr(1013,0,236,1,0,".(goto)", 0, 2, 0);
	trans[1][151]	= settr(1006,0,152,81,0,"(LEG2CRM?[20,TO])", 1, 2, 0);
	trans[1][152]	= settr(1007,0,236,82,82,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][153]	= settr(1008,0,154,83,0,"(LEG2CRM?[20,TF])", 1, 2, 0);
	trans[1][154]	= settr(1009,0,236,84,84,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][155]	= settr(1010,0,156,85,0,"(LEG2CRM?[20,LF])", 1, 2, 0);
	trans[1][156]	= settr(1011,0,236,86,86,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][236] = settr(1091,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1091,0,160,0,0,"sub-sequence", 0, 2, 0);
	trans[1][160]	= settr(1015,0,234,87,0,"printf('C1')", 0, 2, 0);
	T = trans[1][234] = settr(1089,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1089,0,161,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1089,0,195,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1089,0,226,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1089,0,231,0,0,"IF", 0, 2, 0);
	trans[1][161]	= settr(1016,0,194,88,0,"((((C1_bo.oblig==1)&&((C1_bo.role_pl==STUDENT)==1))&&((C1_bo.status==S)==1)))", 1, 2, 0);
	T = trans[ 1][194] = settr(1049,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1049,0,168,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][168] = settr(1023,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1023,2,162,0,0,"ATOMIC", 0, 2, 0);
	trans[1][162]	= settr(1017,4,169,89,89,"printf('\\n\\n')", 0, 2, 0); /* m: 163 -> 0,169 */
	reached1[163] = 1;
	...
	trans[1][169]	= settr(1024,0,173,90,90,"STUDENTexTrace = (STUDENTexTrace|(1<<C1_bo.id))", 1, 2, 0);
	T = trans[ 1][173] = settr(1028,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1028,0,170,0,0,"sub-sequence", 0, 2, 0);
	trans[1][170]	= settr(1025,0,171,91,91,"ChooseAccept_bo.oblig = 1", 1, 2, 0);
	trans[1][171]	= settr(1026,0,172,92,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][172]	= settr(1027,0,177,93,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][177] = settr(1032,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1032,0,174,0,0,"sub-sequence", 0, 2, 0);
	trans[1][174]	= settr(1029,0,175,94,94,"ChooseReject_bo.oblig = 1", 1, 2, 0);
	trans[1][175]	= settr(1030,0,176,95,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][176]	= settr(1031,0,181,96,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][181] = settr(1036,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1036,0,178,0,0,"sub-sequence", 0, 2, 0);
	trans[1][178]	= settr(1033,0,179,97,97,"C1_bo.oblig = 0", 1, 2, 0);
	trans[1][179]	= settr(1034,0,180,98,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][180]	= settr(1035,0,185,99,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][185] = settr(1040,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1040,0,182,0,0,"sub-sequence", 0, 2, 0);
	trans[1][182]	= settr(1037,0,183,100,100,"C2_bo.oblig = 0", 1, 2, 0);
	trans[1][183]	= settr(1038,0,184,101,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][184]	= settr(1039,0,189,102,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][189] = settr(1044,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1044,0,186,0,0,"sub-sequence", 0, 2, 0);
	trans[1][186]	= settr(1041,0,187,103,103,"C3_bo.oblig = 0", 1, 2, 0);
	trans[1][187]	= settr(1042,0,188,104,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][188]	= settr(1043,0,190,105,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][190]	= settr(1045,0,191,106,106,"choose1 = 1", 1, 2, 0);
	trans[1][191]	= settr(1046,0,193,107,0,"printf('C1 is chosen')", 0, 2, 0);
	T = trans[ 1][193] = settr(1048,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1048,0,192,0,0,"sub-sequence", 0, 2, 0);
	trans[1][192]	= settr(1047,0,731,108,108,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][235]	= settr(1090,0,731,1,0,".(goto)", 0, 2, 0);
	trans[1][195]	= settr(1050,0,225,109,0,"((((C1_bo.oblig==1)&&((C1_bo.role_pl==STUDENT)==1))&&((C1_bo.status==TF)==1)))", 1, 2, 0);
	T = trans[ 1][225] = settr(1080,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1080,0,202,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][202] = settr(1057,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1057,2,196,0,0,"ATOMIC", 0, 2, 0);
	trans[1][196]	= settr(1051,0,207,110,110,"printf('\\n\\n')", 0, 2, 0); /* m: 197 -> 0,207 */
	reached1[197] = 1;
	...
	T = trans[ 1][207] = settr(1062,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1062,0,204,0,0,"sub-sequence", 0, 2, 0);
	trans[1][204]	= settr(1059,0,205,111,111,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][205]	= settr(1060,0,206,112,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][206]	= settr(1061,0,211,113,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][211] = settr(1066,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1066,0,208,0,0,"sub-sequence", 0, 2, 0);
	trans[1][208]	= settr(1063,0,209,114,114,"ChooseReject_bo.oblig = 0", 1, 2, 0);
	trans[1][209]	= settr(1064,0,210,115,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][210]	= settr(1065,0,215,116,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][215] = settr(1070,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1070,0,212,0,0,"sub-sequence", 0, 2, 0);
	trans[1][212]	= settr(1067,0,213,117,117,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][213]	= settr(1068,0,214,118,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][214]	= settr(1069,0,222,119,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][222] = settr(1077,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1077,2,216,0,0,"ATOMIC", 0, 2, 0);
	trans[1][216]	= settr(1071,4,224,120,120,"printf('\\n\\n')", 0, 2, 0); /* m: 217 -> 0,224 */
	reached1[217] = 1;
	...
	T = trans[ 1][224] = settr(1079,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1079,0,223,0,0,"sub-sequence", 0, 2, 0);
	trans[1][223]	= settr(1078,0,731,121,121,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][226]	= settr(1081,0,230,122,0,"((((C1_bo.prohib==1)&&((C1_bo.role_pl==STUDENT)==1))&&((C1_bo.status==S)==1)))", 1, 2, 0);
	T = trans[ 1][230] = settr(1085,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1085,0,227,0,0,"sub-sequence", 0, 2, 0);
	trans[1][227]	= settr(1082,0,229,123,0,"printf('Prohibited choice')", 0, 2, 0);
	T = trans[ 1][229] = settr(1084,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1084,0,228,0,0,"sub-sequence", 0, 2, 0);
	trans[1][228]	= settr(1083,0,731,124,124,"CRM2LEG!7,5", 1, 4, 0);
	trans[1][231]	= settr(1086,0,233,2,0,"else", 0, 2, 0);
	T = trans[ 1][233] = settr(1088,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1088,0,232,0,0,"sub-sequence", 0, 2, 0);
	trans[1][232]	= settr(1087,0,731,125,125,"CRM2LEG!6,5", 1, 4, 0);
	T = trans[ 1][247] = settr(1102,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1102,0,245,0,0,"sub-sequence", 0, 2, 0);
	T = trans[1][245] = settr(1100,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1100,0,237,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1100,0,239,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1100,0,241,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1100,0,243,0,0,"IF", 0, 2, 0);
	trans[1][237]	= settr(1092,0,238,126,0,"(LEG2CRM?[21,S])", 1, 2, 0);
	trans[1][238]	= settr(1093,0,324,127,127,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][246]	= settr(1101,0,324,1,0,".(goto)", 0, 2, 0);
	trans[1][239]	= settr(1094,0,240,128,0,"(LEG2CRM?[21,TO])", 1, 2, 0);
	trans[1][240]	= settr(1095,0,324,129,129,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][241]	= settr(1096,0,242,130,0,"(LEG2CRM?[21,TF])", 1, 2, 0);
	trans[1][242]	= settr(1097,0,324,131,131,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][243]	= settr(1098,0,244,132,0,"(LEG2CRM?[21,LF])", 1, 2, 0);
	trans[1][244]	= settr(1099,0,324,133,133,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][324] = settr(1179,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1179,0,248,0,0,"sub-sequence", 0, 2, 0);
	trans[1][248]	= settr(1103,0,322,134,0,"printf('C2')", 0, 2, 0);
	T = trans[1][322] = settr(1177,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1177,0,249,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1177,0,283,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1177,0,314,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1177,0,319,0,0,"IF", 0, 2, 0);
	trans[1][249]	= settr(1104,0,282,135,0,"((((C2_bo.oblig==1)&&((C2_bo.role_pl==STUDENT)==1))&&((C2_bo.status==S)==1)))", 1, 2, 0);
	T = trans[ 1][282] = settr(1137,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1137,0,256,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][256] = settr(1111,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1111,2,250,0,0,"ATOMIC", 0, 2, 0);
	trans[1][250]	= settr(1105,4,257,136,136,"printf('\\n\\n')", 0, 2, 0); /* m: 251 -> 0,257 */
	reached1[251] = 1;
	...
	trans[1][257]	= settr(1112,0,261,137,137,"STUDENTexTrace = (STUDENTexTrace|(1<<C2_bo.id))", 1, 2, 0);
	T = trans[ 1][261] = settr(1116,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1116,0,258,0,0,"sub-sequence", 0, 2, 0);
	trans[1][258]	= settr(1113,0,259,138,138,"ChooseAccept_bo.oblig = 1", 1, 2, 0);
	trans[1][259]	= settr(1114,0,260,139,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][260]	= settr(1115,0,265,140,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][265] = settr(1120,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1120,0,262,0,0,"sub-sequence", 0, 2, 0);
	trans[1][262]	= settr(1117,0,263,141,141,"ChooseReject_bo.oblig = 1", 1, 2, 0);
	trans[1][263]	= settr(1118,0,264,142,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][264]	= settr(1119,0,269,143,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][269] = settr(1124,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1124,0,266,0,0,"sub-sequence", 0, 2, 0);
	trans[1][266]	= settr(1121,0,267,144,144,"C1_bo.oblig = 0", 1, 2, 0);
	trans[1][267]	= settr(1122,0,268,145,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][268]	= settr(1123,0,273,146,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][273] = settr(1128,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1128,0,270,0,0,"sub-sequence", 0, 2, 0);
	trans[1][270]	= settr(1125,0,271,147,147,"C2_bo.oblig = 0", 1, 2, 0);
	trans[1][271]	= settr(1126,0,272,148,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][272]	= settr(1127,0,277,149,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][277] = settr(1132,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1132,0,274,0,0,"sub-sequence", 0, 2, 0);
	trans[1][274]	= settr(1129,0,275,150,150,"C3_bo.oblig = 0", 1, 2, 0);
	trans[1][275]	= settr(1130,0,276,151,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][276]	= settr(1131,0,278,152,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][278]	= settr(1133,0,279,153,153,"choose2 = 1", 1, 2, 0);
	trans[1][279]	= settr(1134,0,281,154,0,"printf('C2 is chosen')", 0, 2, 0);
	T = trans[ 1][281] = settr(1136,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1136,0,280,0,0,"sub-sequence", 0, 2, 0);
	trans[1][280]	= settr(1135,0,731,155,155,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][323]	= settr(1178,0,731,1,0,".(goto)", 0, 2, 0);
	trans[1][283]	= settr(1138,0,313,156,0,"((((C2_bo.oblig==1)&&((C2_bo.role_pl==STUDENT)==1))&&((C2_bo.status==TF)==1)))", 1, 2, 0);
	T = trans[ 1][313] = settr(1168,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1168,0,290,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][290] = settr(1145,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1145,2,284,0,0,"ATOMIC", 0, 2, 0);
	trans[1][284]	= settr(1139,0,295,157,157,"printf('\\n\\n')", 0, 2, 0); /* m: 285 -> 0,295 */
	reached1[285] = 1;
	...
	T = trans[ 1][295] = settr(1150,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1150,0,292,0,0,"sub-sequence", 0, 2, 0);
	trans[1][292]	= settr(1147,0,293,158,158,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][293]	= settr(1148,0,294,159,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][294]	= settr(1149,0,299,160,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][299] = settr(1154,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1154,0,296,0,0,"sub-sequence", 0, 2, 0);
	trans[1][296]	= settr(1151,0,297,161,161,"ChooseReject_bo.oblig = 0", 1, 2, 0);
	trans[1][297]	= settr(1152,0,298,162,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][298]	= settr(1153,0,303,163,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][303] = settr(1158,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1158,0,300,0,0,"sub-sequence", 0, 2, 0);
	trans[1][300]	= settr(1155,0,301,164,164,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][301]	= settr(1156,0,302,165,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][302]	= settr(1157,0,310,166,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][310] = settr(1165,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1165,2,304,0,0,"ATOMIC", 0, 2, 0);
	trans[1][304]	= settr(1159,4,312,167,167,"printf('\\n\\n')", 0, 2, 0); /* m: 305 -> 0,312 */
	reached1[305] = 1;
	...
	T = trans[ 1][312] = settr(1167,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1167,0,311,0,0,"sub-sequence", 0, 2, 0);
	trans[1][311]	= settr(1166,0,731,168,168,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][314]	= settr(1169,0,318,169,0,"((((C2_bo.prohib==1)&&((C2_bo.role_pl==STUDENT)==1))&&((C2_bo.status==S)==1)))", 1, 2, 0);
	T = trans[ 1][318] = settr(1173,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1173,0,315,0,0,"sub-sequence", 0, 2, 0);
	trans[1][315]	= settr(1170,0,317,170,0,"printf('Prohibited choice')", 0, 2, 0);
	T = trans[ 1][317] = settr(1172,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1172,0,316,0,0,"sub-sequence", 0, 2, 0);
	trans[1][316]	= settr(1171,0,731,171,171,"CRM2LEG!7,5", 1, 4, 0);
	trans[1][319]	= settr(1174,0,321,2,0,"else", 0, 2, 0);
	T = trans[ 1][321] = settr(1176,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1176,0,320,0,0,"sub-sequence", 0, 2, 0);
	trans[1][320]	= settr(1175,0,731,172,172,"CRM2LEG!6,5", 1, 4, 0);
	T = trans[ 1][335] = settr(1190,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1190,0,333,0,0,"sub-sequence", 0, 2, 0);
	T = trans[1][333] = settr(1188,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1188,0,325,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1188,0,327,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1188,0,329,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1188,0,331,0,0,"IF", 0, 2, 0);
	trans[1][325]	= settr(1180,0,326,173,0,"(LEG2CRM?[22,S])", 1, 2, 0);
	trans[1][326]	= settr(1181,0,412,174,174,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][334]	= settr(1189,0,412,1,0,".(goto)", 0, 2, 0);
	trans[1][327]	= settr(1182,0,328,175,0,"(LEG2CRM?[22,TO])", 1, 2, 0);
	trans[1][328]	= settr(1183,0,412,176,176,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][329]	= settr(1184,0,330,177,0,"(LEG2CRM?[22,TF])", 1, 2, 0);
	trans[1][330]	= settr(1185,0,412,178,178,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][331]	= settr(1186,0,332,179,0,"(LEG2CRM?[22,LF])", 1, 2, 0);
	trans[1][332]	= settr(1187,0,412,180,180,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][412] = settr(1267,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1267,0,336,0,0,"sub-sequence", 0, 2, 0);
	trans[1][336]	= settr(1191,0,410,181,0,"printf('C3')", 0, 2, 0);
	T = trans[1][410] = settr(1265,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1265,0,337,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1265,0,371,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1265,0,402,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1265,0,407,0,0,"IF", 0, 2, 0);
	trans[1][337]	= settr(1192,0,370,182,0,"((((C3_bo.oblig==1)&&((C3_bo.role_pl==STUDENT)==1))&&((C3_bo.status==S)==1)))", 1, 2, 0);
	T = trans[ 1][370] = settr(1225,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1225,0,344,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][344] = settr(1199,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1199,2,338,0,0,"ATOMIC", 0, 2, 0);
	trans[1][338]	= settr(1193,4,345,183,183,"printf('\\n\\n')", 0, 2, 0); /* m: 339 -> 0,345 */
	reached1[339] = 1;
	...
	trans[1][345]	= settr(1200,0,349,184,184,"STUDENTexTrace = (STUDENTexTrace|(1<<C3_bo.id))", 1, 2, 0);
	T = trans[ 1][349] = settr(1204,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1204,0,346,0,0,"sub-sequence", 0, 2, 0);
	trans[1][346]	= settr(1201,0,347,185,185,"ChooseAccept_bo.oblig = 1", 1, 2, 0);
	trans[1][347]	= settr(1202,0,348,186,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][348]	= settr(1203,0,353,187,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][353] = settr(1208,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1208,0,350,0,0,"sub-sequence", 0, 2, 0);
	trans[1][350]	= settr(1205,0,351,188,188,"ChooseReject_bo.oblig = 1", 1, 2, 0);
	trans[1][351]	= settr(1206,0,352,189,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][352]	= settr(1207,0,357,190,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][357] = settr(1212,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1212,0,354,0,0,"sub-sequence", 0, 2, 0);
	trans[1][354]	= settr(1209,0,355,191,191,"C1_bo.oblig = 0", 1, 2, 0);
	trans[1][355]	= settr(1210,0,356,192,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][356]	= settr(1211,0,361,193,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][361] = settr(1216,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1216,0,358,0,0,"sub-sequence", 0, 2, 0);
	trans[1][358]	= settr(1213,0,359,194,194,"C2_bo.oblig = 0", 1, 2, 0);
	trans[1][359]	= settr(1214,0,360,195,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][360]	= settr(1215,0,365,196,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][365] = settr(1220,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1220,0,362,0,0,"sub-sequence", 0, 2, 0);
	trans[1][362]	= settr(1217,0,363,197,197,"C3_bo.oblig = 0", 1, 2, 0);
	trans[1][363]	= settr(1218,0,364,198,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][364]	= settr(1219,0,366,199,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][366]	= settr(1221,0,367,200,200,"choose3 = 1", 1, 2, 0);
	trans[1][367]	= settr(1222,0,369,201,0,"printf('C3 is chosen')", 0, 2, 0);
	T = trans[ 1][369] = settr(1224,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1224,0,368,0,0,"sub-sequence", 0, 2, 0);
	trans[1][368]	= settr(1223,0,731,202,202,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][411]	= settr(1266,0,731,1,0,".(goto)", 0, 2, 0);
	trans[1][371]	= settr(1226,0,401,203,0,"((((C3_bo.oblig==1)&&((C3_bo.role_pl==STUDENT)==1))&&((C3_bo.status==TF)==1)))", 1, 2, 0);
	T = trans[ 1][401] = settr(1256,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1256,0,378,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][378] = settr(1233,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1233,2,372,0,0,"ATOMIC", 0, 2, 0);
	trans[1][372]	= settr(1227,0,383,204,204,"printf('\\n\\n')", 0, 2, 0); /* m: 373 -> 0,383 */
	reached1[373] = 1;
	...
	T = trans[ 1][383] = settr(1238,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1238,0,380,0,0,"sub-sequence", 0, 2, 0);
	trans[1][380]	= settr(1235,0,381,205,205,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][381]	= settr(1236,0,382,206,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][382]	= settr(1237,0,387,207,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][387] = settr(1242,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1242,0,384,0,0,"sub-sequence", 0, 2, 0);
	trans[1][384]	= settr(1239,0,385,208,208,"ChooseReject_bo.oblig = 0", 1, 2, 0);
	trans[1][385]	= settr(1240,0,386,209,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][386]	= settr(1241,0,391,210,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][391] = settr(1246,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1246,0,388,0,0,"sub-sequence", 0, 2, 0);
	trans[1][388]	= settr(1243,0,389,211,211,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][389]	= settr(1244,0,390,212,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][390]	= settr(1245,0,398,213,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][398] = settr(1253,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1253,2,392,0,0,"ATOMIC", 0, 2, 0);
	trans[1][392]	= settr(1247,4,400,214,214,"printf('\\n\\n')", 0, 2, 0); /* m: 393 -> 0,400 */
	reached1[393] = 1;
	...
	T = trans[ 1][400] = settr(1255,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1255,0,399,0,0,"sub-sequence", 0, 2, 0);
	trans[1][399]	= settr(1254,0,731,215,215,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][402]	= settr(1257,0,406,216,0,"((((C3_bo.prohib==1)&&((C3_bo.role_pl==STUDENT)==1))&&((C3_bo.status==S)==1)))", 1, 2, 0);
	T = trans[ 1][406] = settr(1261,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1261,0,403,0,0,"sub-sequence", 0, 2, 0);
	trans[1][403]	= settr(1258,0,405,217,0,"printf('Prohibited choice')", 0, 2, 0);
	T = trans[ 1][405] = settr(1260,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1260,0,404,0,0,"sub-sequence", 0, 2, 0);
	trans[1][404]	= settr(1259,0,731,218,218,"CRM2LEG!7,5", 1, 4, 0);
	trans[1][407]	= settr(1262,0,409,2,0,"else", 0, 2, 0);
	T = trans[ 1][409] = settr(1264,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1264,0,408,0,0,"sub-sequence", 0, 2, 0);
	trans[1][408]	= settr(1263,0,731,219,219,"CRM2LEG!6,5", 1, 4, 0);
	T = trans[ 1][423] = settr(1278,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1278,0,421,0,0,"sub-sequence", 0, 2, 0);
	T = trans[1][421] = settr(1276,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1276,0,413,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1276,0,415,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1276,0,417,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1276,0,419,0,0,"IF", 0, 2, 0);
	trans[1][413]	= settr(1268,0,414,220,0,"(LEG2CRM?[23,S])", 1, 2, 0);
	trans[1][414]	= settr(1269,0,484,221,221,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][422]	= settr(1277,0,484,1,0,".(goto)", 0, 2, 0);
	trans[1][415]	= settr(1270,0,416,222,0,"(LEG2CRM?[23,TO])", 1, 2, 0);
	trans[1][416]	= settr(1271,0,484,223,223,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][417]	= settr(1272,0,418,224,0,"(LEG2CRM?[23,TF])", 1, 2, 0);
	trans[1][418]	= settr(1273,0,484,225,225,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][419]	= settr(1274,0,420,226,0,"(LEG2CRM?[23,LF])", 1, 2, 0);
	trans[1][420]	= settr(1275,0,484,227,227,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][484] = settr(1339,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1339,0,424,0,0,"sub-sequence", 0, 2, 0);
	trans[1][424]	= settr(1279,0,482,228,0,"printf('Accept the choice ')", 0, 2, 0);
	T = trans[1][482] = settr(1337,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1337,0,425,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1337,0,452,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1337,0,479,0,0,"IF", 0, 2, 0);
	trans[1][425]	= settr(1280,0,451,229,0,"((((ChooseAccept_bo.oblig==1)&&((ChooseAccept_bo.role_pl==LMS)==1))&&((ChooseAccept_bo.status==S)==1)))", 1, 2, 0);
	T = trans[ 1][451] = settr(1306,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1306,0,432,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][432] = settr(1287,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1287,2,426,0,0,"ATOMIC", 0, 2, 0);
	trans[1][426]	= settr(1281,4,433,230,230,"printf('\\n\\n')", 0, 2, 0); /* m: 427 -> 0,433 */
	reached1[427] = 1;
	...
	trans[1][433]	= settr(1288,0,437,231,231,"LMSexTrace = (LMSexTrace|(1<<ChooseAccept_bo.id))", 1, 2, 0);
	T = trans[ 1][437] = settr(1292,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1292,0,434,0,0,"sub-sequence", 0, 2, 0);
	trans[1][434]	= settr(1289,0,435,232,232,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][435]	= settr(1290,0,436,233,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][436]	= settr(1291,0,441,234,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][441] = settr(1296,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1296,0,438,0,0,"sub-sequence", 0, 2, 0);
	trans[1][438]	= settr(1293,0,439,235,235,"ChooseReject_bo.oblig = 0", 1, 2, 0);
	trans[1][439]	= settr(1294,0,440,236,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][440]	= settr(1295,0,448,237,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][448] = settr(1303,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1303,2,442,0,0,"ATOMIC", 0, 2, 0);
	trans[1][442]	= settr(1297,4,450,238,238,"printf('\\n\\n')", 0, 2, 0); /* m: 443 -> 0,450 */
	reached1[443] = 1;
	...
	T = trans[ 1][450] = settr(1305,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1305,0,449,0,0,"sub-sequence", 0, 2, 0);
	trans[1][449]	= settr(1304,0,731,239,239,"CRM2LEG!8,2", 1, 4, 0);
	trans[1][483]	= settr(1338,0,731,1,0,".(goto)", 0, 2, 0);
	trans[1][452]	= settr(1307,0,478,240,0,"((((ChooseAccept_bo.oblig==1)&&((ChooseAccept_bo.role_pl==LMS)==1))&&((ChooseAccept_bo.status==TF)==1)))", 1, 2, 0);
	T = trans[ 1][478] = settr(1333,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1333,0,459,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][459] = settr(1314,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1314,2,453,0,0,"ATOMIC", 0, 2, 0);
	trans[1][453]	= settr(1308,0,464,241,241,"printf('\\n\\n')", 0, 2, 0); /* m: 454 -> 0,464 */
	reached1[454] = 1;
	...
	T = trans[ 1][464] = settr(1319,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1319,0,461,0,0,"sub-sequence", 0, 2, 0);
	trans[1][461]	= settr(1316,0,462,242,242,"ChooseAccept_bo.oblig = 1", 1, 2, 0);
	trans[1][462]	= settr(1317,0,463,243,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][463]	= settr(1318,0,468,244,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][468] = settr(1323,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1323,0,465,0,0,"sub-sequence", 0, 2, 0);
	trans[1][465]	= settr(1320,0,466,245,245,"ChooseReject_bo.oblig = 1", 1, 2, 0);
	trans[1][466]	= settr(1321,0,467,246,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][467]	= settr(1322,0,475,247,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][475] = settr(1330,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1330,2,469,0,0,"ATOMIC", 0, 2, 0);
	trans[1][469]	= settr(1324,4,477,248,248,"printf('\\n\\n')", 0, 2, 0); /* m: 470 -> 0,477 */
	reached1[470] = 1;
	...
	T = trans[ 1][477] = settr(1332,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1332,0,476,0,0,"sub-sequence", 0, 2, 0);
	trans[1][476]	= settr(1331,0,731,249,249,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][479]	= settr(1334,0,481,2,0,"else", 0, 2, 0);
	T = trans[ 1][481] = settr(1336,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1336,0,480,0,0,"sub-sequence", 0, 2, 0);
	trans[1][480]	= settr(1335,0,731,250,250,"CRM2LEG!6,5", 1, 4, 0);
	T = trans[ 1][495] = settr(1350,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1350,0,493,0,0,"sub-sequence", 0, 2, 0);
	T = trans[1][493] = settr(1348,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1348,0,485,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1348,0,487,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1348,0,489,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1348,0,491,0,0,"IF", 0, 2, 0);
	trans[1][485]	= settr(1340,0,486,251,0,"(LEG2CRM?[24,S])", 1, 2, 0);
	trans[1][486]	= settr(1341,0,730,252,252,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][494]	= settr(1349,0,730,1,0,".(goto)", 0, 2, 0);
	trans[1][487]	= settr(1342,0,488,253,0,"(LEG2CRM?[24,TO])", 1, 2, 0);
	trans[1][488]	= settr(1343,0,730,254,254,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][489]	= settr(1344,0,490,255,0,"(LEG2CRM?[24,TF])", 1, 2, 0);
	trans[1][490]	= settr(1345,0,730,256,256,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][491]	= settr(1346,0,492,257,0,"(LEG2CRM?[24,LF])", 1, 2, 0);
	trans[1][492]	= settr(1347,0,730,258,258,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][730] = settr(1585,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1585,0,496,0,0,"sub-sequence", 0, 2, 0);
	trans[1][496]	= settr(1351,0,728,259,0,"printf('Reject the choice ')", 0, 2, 0);
	T = trans[1][728] = settr(1583,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1583,0,497,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1583,0,698,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1583,0,725,0,0,"IF", 0, 2, 0);
	trans[1][497]	= settr(1352,0,697,260,0,"((((ChooseReject_bo.oblig==1)&&((ChooseReject_bo.role_pl==LMS)==1))&&((ChooseReject_bo.status==S)==1)))", 1, 2, 0);
	T = trans[ 1][697] = settr(1552,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1552,0,504,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][504] = settr(1359,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1359,2,498,0,0,"ATOMIC", 0, 2, 0);
	trans[1][498]	= settr(1353,4,505,261,261,"printf('\\n\\n')", 0, 2, 0); /* m: 499 -> 0,505 */
	reached1[499] = 1;
	...
	trans[1][505]	= settr(1360,0,509,262,262,"LMSexTrace = (LMSexTrace|(1<<ChooseReject_bo.id))", 1, 2, 0);
	T = trans[ 1][509] = settr(1364,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1364,0,506,0,0,"sub-sequence", 0, 2, 0);
	trans[1][506]	= settr(1361,0,507,263,263,"ChooseReject_bo.oblig = 0", 1, 2, 0);
	trans[1][507]	= settr(1362,0,508,264,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][508]	= settr(1363,0,513,265,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][513] = settr(1368,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1368,0,510,0,0,"sub-sequence", 0, 2, 0);
	trans[1][510]	= settr(1365,0,511,266,266,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][511]	= settr(1366,0,512,267,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][512]	= settr(1367,0,679,268,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[1][679] = settr(1534,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1534,0,514,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1534,0,569,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1534,0,624,0,0,"IF", 0, 2, 0);
	trans[1][514]	= settr(1369,0,518,269,0,"((choose1==1))", 1, 2, 0);
	T = trans[ 1][518] = settr(1373,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1373,0,515,0,0,"sub-sequence", 0, 2, 0);
	trans[1][515]	= settr(1370,0,516,270,270,"C1_bo.prohib = 1", 1, 2, 0);
	trans[1][516]	= settr(1371,0,517,271,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][517]	= settr(1372,0,542,272,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][542] = settr(1397,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1397,0,519,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1397,0,537,0,0,"IF", 0, 2, 0);
	trans[1][519]	= settr(1374,0,523,273,0,"((choose2==1))", 1, 2, 0);
	T = trans[ 1][523] = settr(1378,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1378,0,520,0,0,"sub-sequence", 0, 2, 0);
	trans[1][520]	= settr(1375,0,521,274,274,"C2_bo.prohib = 1", 1, 2, 0);
	trans[1][521]	= settr(1376,0,522,275,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][522]	= settr(1377,0,535,276,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][535] = settr(1390,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1390,0,524,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1390,0,530,0,0,"IF", 0, 2, 0);
	trans[1][524]	= settr(1379,0,528,277,0,"((choose3==1))", 1, 2, 0);
	T = trans[ 1][528] = settr(1383,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1383,0,525,0,0,"sub-sequence", 0, 2, 0);
	trans[1][525]	= settr(1380,0,526,278,278,"C3_bo.prohib = 1", 1, 2, 0);
	trans[1][526]	= settr(1381,0,527,279,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][527]	= settr(1382,0,529,280,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.oblig==1))))", 1, 2, 0);
	trans[1][529]	= settr(1384,0,567,281,281,"all = 1", 1, 2, 0);
	trans[1][536]	= settr(1391,0,567,1,0,".(goto)", 0, 2, 0);
	trans[1][530]	= settr(1385,0,534,2,0,"else", 0, 2, 0);
	T = trans[ 1][534] = settr(1389,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1389,0,531,0,0,"sub-sequence", 0, 2, 0);
	trans[1][531]	= settr(1386,0,532,282,282,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][532]	= settr(1387,0,533,283,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][533]	= settr(1388,0,567,284,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][543]	= settr(1398,0,567,1,0,".(goto)", 0, 2, 0);
	trans[1][537]	= settr(1392,0,541,2,0,"else", 0, 2, 0);
	T = trans[ 1][541] = settr(1396,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1396,0,538,0,0,"sub-sequence", 0, 2, 0);
	trans[1][538]	= settr(1393,0,539,285,285,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][539]	= settr(1394,0,540,286,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][540]	= settr(1395,0,567,287,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[1][567] = settr(1422,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1422,0,544,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1422,0,562,0,0,"IF", 0, 2, 0);
	trans[1][544]	= settr(1399,0,548,288,0,"((choose3==1))", 1, 2, 0);
	T = trans[ 1][548] = settr(1403,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1403,0,545,0,0,"sub-sequence", 0, 2, 0);
	trans[1][545]	= settr(1400,0,546,289,289,"C3_bo.prohib = 1", 1, 2, 0);
	trans[1][546]	= settr(1401,0,547,290,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][547]	= settr(1402,0,560,291,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][560] = settr(1415,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1415,0,549,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1415,0,555,0,0,"IF", 0, 2, 0);
	trans[1][549]	= settr(1404,0,553,292,0,"((choose2==1))", 1, 2, 0);
	T = trans[ 1][553] = settr(1408,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1408,0,550,0,0,"sub-sequence", 0, 2, 0);
	trans[1][550]	= settr(1405,0,551,293,293,"C2_bo.prohib = 1", 1, 2, 0);
	trans[1][551]	= settr(1406,0,552,294,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][552]	= settr(1407,0,554,295,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.oblig==1))))", 1, 2, 0);
	trans[1][554]	= settr(1409,0,687,296,296,"all = 1", 1, 2, 0);
	trans[1][561]	= settr(1416,0,687,1,0,".(goto)", 0, 2, 0);
	trans[1][555]	= settr(1410,0,559,2,0,"else", 0, 2, 0);
	T = trans[ 1][559] = settr(1414,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1414,0,556,0,0,"sub-sequence", 0, 2, 0);
	trans[1][556]	= settr(1411,0,557,297,297,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][557]	= settr(1412,0,558,298,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][558]	= settr(1413,0,687,299,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][568]	= settr(1423,0,687,1,0,".(goto)", 0, 2, 0);
	trans[1][562]	= settr(1417,0,566,2,0,"else", 0, 2, 0);
	T = trans[ 1][566] = settr(1421,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1421,0,563,0,0,"sub-sequence", 0, 2, 0);
	trans[1][563]	= settr(1418,0,564,300,300,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][564]	= settr(1419,0,565,301,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][565]	= settr(1420,0,687,302,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][680]	= settr(1535,0,687,1,0,".(goto)", 0, 2, 0);
	trans[1][569]	= settr(1424,0,573,303,0,"((choose2==1))", 1, 2, 0);
	T = trans[ 1][573] = settr(1428,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1428,0,570,0,0,"sub-sequence", 0, 2, 0);
	trans[1][570]	= settr(1425,0,571,304,304,"C2_bo.prohib = 1", 1, 2, 0);
	trans[1][571]	= settr(1426,0,572,305,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][572]	= settr(1427,0,597,306,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][597] = settr(1452,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1452,0,574,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1452,0,592,0,0,"IF", 0, 2, 0);
	trans[1][574]	= settr(1429,0,578,307,0,"((choose1==1))", 1, 2, 0);
	T = trans[ 1][578] = settr(1433,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1433,0,575,0,0,"sub-sequence", 0, 2, 0);
	trans[1][575]	= settr(1430,0,576,308,308,"C1_bo.prohib = 1", 1, 2, 0);
	trans[1][576]	= settr(1431,0,577,309,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][577]	= settr(1432,0,590,310,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][590] = settr(1445,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1445,0,579,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1445,0,585,0,0,"IF", 0, 2, 0);
	trans[1][579]	= settr(1434,0,583,311,0,"((choose3==1))", 1, 2, 0);
	T = trans[ 1][583] = settr(1438,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1438,0,580,0,0,"sub-sequence", 0, 2, 0);
	trans[1][580]	= settr(1435,0,581,312,312,"C3_bo.prohib = 1", 1, 2, 0);
	trans[1][581]	= settr(1436,0,582,313,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][582]	= settr(1437,0,584,314,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.oblig==1))))", 1, 2, 0);
	trans[1][584]	= settr(1439,0,622,315,315,"all = 1", 1, 2, 0);
	trans[1][591]	= settr(1446,0,622,1,0,".(goto)", 0, 2, 0);
	trans[1][585]	= settr(1440,0,589,2,0,"else", 0, 2, 0);
	T = trans[ 1][589] = settr(1444,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1444,0,586,0,0,"sub-sequence", 0, 2, 0);
	trans[1][586]	= settr(1441,0,587,316,316,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][587]	= settr(1442,0,588,317,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][588]	= settr(1443,0,622,318,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][598]	= settr(1453,0,622,1,0,".(goto)", 0, 2, 0);
	trans[1][592]	= settr(1447,0,596,2,0,"else", 0, 2, 0);
	T = trans[ 1][596] = settr(1451,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1451,0,593,0,0,"sub-sequence", 0, 2, 0);
	trans[1][593]	= settr(1448,0,594,319,319,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][594]	= settr(1449,0,595,320,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][595]	= settr(1450,0,622,321,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[1][622] = settr(1477,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1477,0,599,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1477,0,617,0,0,"IF", 0, 2, 0);
	trans[1][599]	= settr(1454,0,603,322,0,"((choose3==1))", 1, 2, 0);
	T = trans[ 1][603] = settr(1458,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1458,0,600,0,0,"sub-sequence", 0, 2, 0);
	trans[1][600]	= settr(1455,0,601,323,323,"C3_bo.prohib = 1", 1, 2, 0);
	trans[1][601]	= settr(1456,0,602,324,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][602]	= settr(1457,0,615,325,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][615] = settr(1470,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1470,0,604,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1470,0,610,0,0,"IF", 0, 2, 0);
	trans[1][604]	= settr(1459,0,608,326,0,"((choose1==1))", 1, 2, 0);
	T = trans[ 1][608] = settr(1463,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1463,0,605,0,0,"sub-sequence", 0, 2, 0);
	trans[1][605]	= settr(1460,0,606,327,327,"C1_bo.prohib = 1", 1, 2, 0);
	trans[1][606]	= settr(1461,0,607,328,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][607]	= settr(1462,0,609,329,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.oblig==1))))", 1, 2, 0);
	trans[1][609]	= settr(1464,0,687,330,330,"all = 1", 1, 2, 0);
	trans[1][616]	= settr(1471,0,687,1,0,".(goto)", 0, 2, 0);
	trans[1][610]	= settr(1465,0,614,2,0,"else", 0, 2, 0);
	T = trans[ 1][614] = settr(1469,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1469,0,611,0,0,"sub-sequence", 0, 2, 0);
	trans[1][611]	= settr(1466,0,612,331,331,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][612]	= settr(1467,0,613,332,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][613]	= settr(1468,0,687,333,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][623]	= settr(1478,0,687,1,0,".(goto)", 0, 2, 0);
	trans[1][617]	= settr(1472,0,621,2,0,"else", 0, 2, 0);
	T = trans[ 1][621] = settr(1476,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1476,0,618,0,0,"sub-sequence", 0, 2, 0);
	trans[1][618]	= settr(1473,0,619,334,334,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][619]	= settr(1474,0,620,335,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][620]	= settr(1475,0,687,336,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][624]	= settr(1479,0,628,337,0,"((choose3==1))", 1, 2, 0);
	T = trans[ 1][628] = settr(1483,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1483,0,625,0,0,"sub-sequence", 0, 2, 0);
	trans[1][625]	= settr(1480,0,626,338,338,"C3_bo.prohib = 1", 1, 2, 0);
	trans[1][626]	= settr(1481,0,627,339,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][627]	= settr(1482,0,652,340,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][652] = settr(1507,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1507,0,629,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1507,0,647,0,0,"IF", 0, 2, 0);
	trans[1][629]	= settr(1484,0,633,341,0,"((choose2==1))", 1, 2, 0);
	T = trans[ 1][633] = settr(1488,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1488,0,630,0,0,"sub-sequence", 0, 2, 0);
	trans[1][630]	= settr(1485,0,631,342,342,"C2_bo.prohib = 1", 1, 2, 0);
	trans[1][631]	= settr(1486,0,632,343,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][632]	= settr(1487,0,645,344,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][645] = settr(1500,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1500,0,634,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1500,0,640,0,0,"IF", 0, 2, 0);
	trans[1][634]	= settr(1489,0,638,345,0,"((choose1==1))", 1, 2, 0);
	T = trans[ 1][638] = settr(1493,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1493,0,635,0,0,"sub-sequence", 0, 2, 0);
	trans[1][635]	= settr(1490,0,636,346,346,"C1_bo.prohib = 1", 1, 2, 0);
	trans[1][636]	= settr(1491,0,637,347,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][637]	= settr(1492,0,639,348,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.oblig==1))))", 1, 2, 0);
	trans[1][639]	= settr(1494,0,677,349,349,"all = 1", 1, 2, 0);
	trans[1][646]	= settr(1501,0,677,1,0,".(goto)", 0, 2, 0);
	trans[1][640]	= settr(1495,0,644,2,0,"else", 0, 2, 0);
	T = trans[ 1][644] = settr(1499,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1499,0,641,0,0,"sub-sequence", 0, 2, 0);
	trans[1][641]	= settr(1496,0,642,350,350,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][642]	= settr(1497,0,643,351,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][643]	= settr(1498,0,677,352,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][653]	= settr(1508,0,677,1,0,".(goto)", 0, 2, 0);
	trans[1][647]	= settr(1502,0,651,2,0,"else", 0, 2, 0);
	T = trans[ 1][651] = settr(1506,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1506,0,648,0,0,"sub-sequence", 0, 2, 0);
	trans[1][648]	= settr(1503,0,649,353,353,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][649]	= settr(1504,0,650,354,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][650]	= settr(1505,0,677,355,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[1][677] = settr(1532,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1532,0,654,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1532,0,672,0,0,"IF", 0, 2, 0);
	trans[1][654]	= settr(1509,0,658,356,0,"((choose1==1))", 1, 2, 0);
	T = trans[ 1][658] = settr(1513,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1513,0,655,0,0,"sub-sequence", 0, 2, 0);
	trans[1][655]	= settr(1510,0,656,357,357,"C1_bo.prohib = 1", 1, 2, 0);
	trans[1][656]	= settr(1511,0,657,358,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][657]	= settr(1512,0,670,359,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][670] = settr(1525,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1525,0,659,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1525,0,665,0,0,"IF", 0, 2, 0);
	trans[1][659]	= settr(1514,0,663,360,0,"((choose2==1))", 1, 2, 0);
	T = trans[ 1][663] = settr(1518,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1518,0,660,0,0,"sub-sequence", 0, 2, 0);
	trans[1][660]	= settr(1515,0,661,361,361,"C2_bo.prohib = 1", 1, 2, 0);
	trans[1][661]	= settr(1516,0,662,362,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][662]	= settr(1517,0,664,363,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.oblig==1))))", 1, 2, 0);
	trans[1][664]	= settr(1519,0,687,364,364,"all = 1", 1, 2, 0);
	trans[1][671]	= settr(1526,0,687,1,0,".(goto)", 0, 2, 0);
	trans[1][665]	= settr(1520,0,669,2,0,"else", 0, 2, 0);
	T = trans[ 1][669] = settr(1524,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1524,0,666,0,0,"sub-sequence", 0, 2, 0);
	trans[1][666]	= settr(1521,0,667,365,365,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][667]	= settr(1522,0,668,366,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][668]	= settr(1523,0,687,367,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][678]	= settr(1533,0,687,1,0,".(goto)", 0, 2, 0);
	trans[1][672]	= settr(1527,0,676,2,0,"else", 0, 2, 0);
	T = trans[ 1][676] = settr(1531,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1531,0,673,0,0,"sub-sequence", 0, 2, 0);
	trans[1][673]	= settr(1528,0,674,368,368,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][674]	= settr(1529,0,675,369,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][675]	= settr(1530,0,687,370,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][687] = settr(1542,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1542,2,681,0,0,"ATOMIC", 0, 2, 0);
	trans[1][681]	= settr(1536,4,695,371,371,"printf('\\n\\n')", 0, 2, 0); /* m: 682 -> 0,695 */
	reached1[682] = 1;
	...
	T = trans[1][695] = settr(1550,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1550,0,688,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1550,0,692,0,0,"IF", 0, 2, 0);
	trans[1][688]	= settr(1543,0,689,372,0,"((all==1))", 1, 2, 0);
	trans[1][689]	= settr(1544,0,691,373,0,"printf('No course is suitable for you')", 0, 2, 0);
	T = trans[ 1][691] = settr(1546,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1546,0,690,0,0,"sub-sequence", 0, 2, 0);
	trans[1][690]	= settr(1545,0,731,374,374,"CRM2LEG!8,2", 1, 4, 0);
	trans[1][696]	= settr(1551,0,731,1,0,".(goto)", 0, 2, 0);
	trans[1][692]	= settr(1547,0,694,2,0,"else", 0, 2, 0);
	T = trans[ 1][694] = settr(1549,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1549,0,693,0,0,"sub-sequence", 0, 2, 0);
	trans[1][693]	= settr(1548,0,731,375,375,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][729]	= settr(1584,0,731,1,0,".(goto)", 0, 2, 0);
	trans[1][698]	= settr(1553,0,724,376,0,"((((ChooseReject_bo.oblig==1)&&((ChooseReject_bo.role_pl==LMS)==1))&&((ChooseReject_bo.status==TF)==1)))", 1, 2, 0);
	T = trans[ 1][724] = settr(1579,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1579,0,705,0,0,"sub-sequence", 0, 2, 0);
	T = trans[ 1][705] = settr(1560,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1560,2,699,0,0,"ATOMIC", 0, 2, 0);
	trans[1][699]	= settr(1554,0,710,377,377,"printf('\\n\\n')", 0, 2, 0); /* m: 700 -> 0,710 */
	reached1[700] = 1;
	...
	T = trans[ 1][710] = settr(1565,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1565,0,707,0,0,"sub-sequence", 0, 2, 0);
	trans[1][707]	= settr(1562,0,708,378,378,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][708]	= settr(1563,0,709,379,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][709]	= settr(1564,0,714,380,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][714] = settr(1569,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1569,0,711,0,0,"sub-sequence", 0, 2, 0);
	trans[1][711]	= settr(1566,0,712,381,381,"ChooseReject_bo.oblig = 1", 1, 2, 0);
	trans[1][712]	= settr(1567,0,713,382,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][713]	= settr(1568,0,721,383,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][721] = settr(1576,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1576,2,715,0,0,"ATOMIC", 0, 2, 0);
	trans[1][715]	= settr(1570,4,723,384,384,"printf('\\n\\n')", 0, 2, 0); /* m: 716 -> 0,723 */
	reached1[716] = 1;
	...
	T = trans[ 1][723] = settr(1578,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1578,0,722,0,0,"sub-sequence", 0, 2, 0);
	trans[1][722]	= settr(1577,0,731,385,385,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][725]	= settr(1580,0,727,2,0,"else", 0, 2, 0);
	T = trans[ 1][727] = settr(1582,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1582,0,726,0,0,"sub-sequence", 0, 2, 0);
	trans[1][726]	= settr(1581,0,731,386,386,"CRM2LEG!6,5", 1, 4, 0);
	trans[1][733]	= settr(1588,0,734,1,0,"break", 0, 2, 0);
	trans[1][734]	= settr(1589,0,0,387,387,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][68]	= settr(67,32,853,398,398,"D_STEP174", 1, 2, 0);
	...
	trans[0][105]	= settr(104,0,853,412,412,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][108]	= settr(107,0,853,413,413,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][111]	= settr(110,0,853,414,414,"CRM2LEG?7,2", 1, 504, 0);
	...
	trans[0][151]	= settr(150,0,853,428,428,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][154]	= settr(153,0,853,429,429,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][157]	= settr(156,0,853,430,430,"CRM2LEG?7,2", 1, 504, 0);
	...
	trans[0][197]	= settr(196,0,853,444,444,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][200]	= settr(199,0,853,445,445,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][203]	= settr(202,0,853,446,446,"CRM2LEG?7,2", 1, 504, 0);
	...
	trans[0][243]	= settr(242,0,853,460,460,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][246]	= settr(245,0,853,461,461,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][249]	= settr(248,0,853,462,462,"CRM2LEG?7,2", 1, 504, 0);
	...
	trans[0][289]	= settr(288,0,853,476,476,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][292]	= settr(291,0,853,477,477,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][295]	= settr(294,0,853,478,478,"CRM2LEG?7,2", 1, 504, 0);
	...
	trans[0][302]	= settr(301,0,304,480,480,"C1_bo.status = P", 1, 2, 0);
	T = trans[ 0][304] = settr(303,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(303,0,303,0,0,"sub-sequence", 0, 2, 0);
	trans[0][303]	= settr(302,0,346,481,481,"LEG2CRM!20,13", 1, 3, 0);
	...
	trans[0][335]	= settr(334,0,853,492,492,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][338]	= settr(337,0,853,493,493,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][341]	= settr(340,0,853,494,494,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][343]	= settr(342,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][347]	= settr(346,0,348,495,0,"((((C1_bo.right==1)||(C1_bo.oblig==1))||(C1_bo.prohib==1)))", 1, 2, 0);
	trans[0][348]	= settr(347,0,350,496,496,"C1_bo.status = TF", 1, 2, 0);
	T = trans[ 0][350] = settr(349,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(349,0,349,0,0,"sub-sequence", 0, 2, 0);
	trans[0][349]	= settr(348,0,392,497,497,"LEG2CRM!20,15", 1, 3, 0);
	...
	trans[0][381]	= settr(380,0,853,508,508,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][384]	= settr(383,0,853,509,509,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][387]	= settr(386,0,853,510,510,"CRM2LEG?7,2", 1, 504, 0);
	...
	trans[0][394]	= settr(393,0,396,512,512,"C2_bo.status = S", 1, 2, 0);
	T = trans[ 0][396] = settr(395,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(395,0,395,0,0,"sub-sequence", 0, 2, 0);
	trans[0][395]	= settr(394,0,438,513,513,"LEG2CRM!21,17", 1, 3, 0);
	...
	trans[0][427]	= settr(426,0,853,524,524,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][430]	= settr(429,0,853,525,525,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][433]	= settr(432,0,853,526,526,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][435]	= settr(434,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][439]	= settr(438,0,440,527,0,"((((C2_bo.right==1)||(C2_bo.oblig==1))||(C2_bo.prohib==1)))", 1, 2, 0);
	trans[0][440]	= settr(439,0,442,528,528,"C2_bo.status = P", 1, 2, 0);
	T = trans[ 0][442] = settr(441,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(441,0,441,0,0,"sub-sequence", 0, 2, 0);
	trans[0][441]	= settr(440,0,484,529,529,"LEG2CRM!21,13", 1, 3, 0);
	...
	trans[0][473]	= settr(472,0,853,540,540,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][476]	= settr(475,0,853,541,541,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][479]	= settr(478,0,853,542,542,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][481]	= settr(480,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][485]	= settr(484,0,486,543,0,"((((C2_bo.right==1)||(C2_bo.oblig==1))||(C2_bo.prohib==1)))", 1, 2, 0);
	trans[0][486]	= settr(485,0,488,544,544,"C2_bo.status = TF", 1, 2, 0);
	T = trans[ 0][488] = settr(487,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(487,0,487,0,0,"sub-sequence", 0, 2, 0);
	trans[0][487]	= settr(486,0,530,545,545,"LEG2CRM!21,15", 1, 3, 0);
	...
	trans[0][519]	= settr(518,0,853,556,556,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][522]	= settr(521,0,853,557,557,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][525]	= settr(524,0,853,558,558,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][527]	= settr(526,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][531]	= settr(530,0,532,559,0,"((((C3_bo.right==1)||(C3_bo.oblig==1))||(C3_bo.prohib==1)))", 1, 2, 0);
	trans[0][532]	= settr(531,0,534,560,560,"C3_bo.status = S", 1, 2, 0);
	T = trans[ 0][534] = settr(533,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(533,0,533,0,0,"sub-sequence", 0, 2, 0);
	trans[0][533]	= settr(532,0,576,561,561,"LEG2CRM!22,17", 1, 3, 0);
	...
	trans[0][565]	= settr(564,0,853,572,572,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][568]	= settr(567,0,853,573,573,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][571]	= settr(570,0,853,574,574,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][573]	= settr(572,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][577]	= settr(576,0,578,575,0,"((((C3_bo.right==1)||(C3_bo.oblig==1))||(C3_bo.prohib==1)))", 1, 2, 0);
	trans[0][578]	= settr(577,0,580,576,576,"C3_bo.status = P", 1, 2, 0);
	T = trans[ 0][580] = settr(579,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(579,0,579,0,0,"sub-sequence", 0, 2, 0);
	trans[0][579]	= settr(578,0,622,577,577,"LEG2CRM!22,13", 1, 3, 0);
	...
	trans[0][611]	= settr(610,0,853,588,588,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][614]	= settr(613,0,853,589,589,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][617]	= settr(616,0,853,590,590,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][619]	= settr(618,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][623]	= settr(622,0,624,591,0,"((((C3_bo.right==1)||(C3_bo.oblig==1))||(C3_bo.prohib==1)))", 1, 2, 0);
	trans[0][624]	= settr(623,0,626,592,592,"C3_bo.status = TF", 1, 2, 0);
	T = trans[ 0][626] = settr(625,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(625,0,625,0,0,"sub-sequence", 0, 2, 0);
	trans[0][625]	= settr(624,0,668,593,593,"LEG2CRM!22,15", 1, 3, 0);
	...
	trans[0][657]	= settr(656,0,853,604,604,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][660]	= settr(659,0,853,605,605,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][663]	= settr(662,0,853,606,606,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][665]	= settr(664,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][669]	= settr(668,0,670,607,0,"((((ChooseAccept_bo.right==1)||(ChooseAccept_bo.oblig==1))||(ChooseAccept_bo.prohib==1)))", 1, 2, 0);
	trans[0][670]	= settr(669,0,672,608,608,"ChooseAccept_bo.status = S", 1, 2, 0);
	T = trans[ 0][672] = settr(671,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(671,0,671,0,0,"sub-sequence", 0, 2, 0);
	trans[0][671]	= settr(670,0,714,609,609,"LEG2CRM!23,17", 1, 3, 0);
	...
	trans[0][703]	= settr(702,0,853,620,620,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][706]	= settr(705,0,853,621,621,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][709]	= settr(708,0,853,622,622,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][711]	= settr(710,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][715]	= settr(714,0,716,623,0,"((((ChooseAccept_bo.right==1)||(ChooseAccept_bo.oblig==1))||(ChooseAccept_bo.prohib==1)))", 1, 2, 0);
	trans[0][716]	= settr(715,0,718,624,624,"ChooseAccept_bo.status = TF", 1, 2, 0);
	T = trans[ 0][718] = settr(717,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(717,0,717,0,0,"sub-sequence", 0, 2, 0);
	trans[0][717]	= settr(716,0,760,625,625,"LEG2CRM!23,15", 1, 3, 0);
	...
	trans[0][719]	= settr(718,0,721,626,626,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][722]	= settr(721,0,724,627,627,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][725]	= settr(724,0,727,628,628,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][728]	= settr(727,0,730,629,629,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][731]	= settr(730,0,70,630,630,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][734]	= settr(733,0,70,631,631,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][737]	= settr(736,0,70,632,632,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][740]	= settr(739,0,70,633,633,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][743]	= settr(742,0,70,634,634,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][746]	= settr(745,0,70,635,635,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][749]	= settr(748,0,853,636,636,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][752]	= settr(751,0,853,637,637,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][755]	= settr(754,0,853,638,638,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][757]	= settr(756,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][761]	= settr(760,0,762,639,0,"((((ChooseReject_bo.right==1)||(ChooseReject_bo.oblig==1))||(ChooseReject_bo.prohib==1)))", 1, 2, 0);
	trans[0][762]	= settr(761,0,764,640,640,"ChooseReject_bo.status = S", 1, 2, 0);
	T = trans[ 0][764] = settr(763,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(763,0,763,0,0,"sub-sequence", 0, 2, 0);
	trans[0][763]	= settr(762,0,806,641,641,"LEG2CRM!24,17", 1, 3, 0);
	...
	trans[0][765]	= settr(764,0,767,642,642,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][768]	= settr(767,0,770,643,643,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][771]	= settr(770,0,773,644,644,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][774]	= settr(773,0,776,645,645,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][777]	= settr(776,0,70,646,646,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][780]	= settr(779,0,70,647,647,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][783]	= settr(782,0,70,648,648,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][786]	= settr(785,0,70,649,649,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][789]	= settr(788,0,70,650,650,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][792]	= settr(791,0,70,651,651,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][795]	= settr(794,0,853,652,652,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][798]	= settr(797,0,853,653,653,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][801]	= settr(800,0,853,654,654,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][803]	= settr(802,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][807]	= settr(806,0,808,655,0,"((((ChooseReject_bo.right==1)||(ChooseReject_bo.oblig==1))||(ChooseReject_bo.prohib==1)))", 1, 2, 0);
	trans[0][808]	= settr(807,0,810,656,656,"ChooseReject_bo.status = TF", 1, 2, 0);
	T = trans[ 0][810] = settr(809,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(809,0,809,0,0,"sub-sequence", 0, 2, 0);
	trans[0][809]	= settr(808,0,852,657,657,"LEG2CRM!24,15", 1, 3, 0);
	...
	trans[0][811]	= settr(810,0,813,658,658,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][814]	= settr(813,0,816,659,659,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][817]	= settr(816,0,819,660,660,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][820]	= settr(819,0,822,661,661,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][823]	= settr(822,0,70,662,662,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][826]	= settr(825,0,70,663,663,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][829]	= settr(828,0,70,664,664,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][832]	= settr(831,0,70,665,665,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][835]	= settr(834,0,70,666,666,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][838]	= settr(837,0,70,667,667,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][841]	= settr(840,0,853,668,668,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][844]	= settr(843,0,853,669,669,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][847]	= settr(846,0,853,670,670,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][849]	= settr(848,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][855]	= settr(854,0,856,1,0,"break", 0, 2, 0);
	trans[0][856]	= settr(855,0,0,671,671,"-end-", 0, 3500, 0);
	/* np_ demon: */

...
{	Trans *T;
	...
	trans[3][7]	= settr(1610,0,6,1,0,".(goto)", 0, 2, 0);
	T = trans[3][6] = settr(1609,0,0,0,0,"DO", 0, 2, 0);
	T = T->nxt	= settr(1609,0,3,0,0,"DO", 0, 2, 0);
	    T->nxt	= settr(1609,0,4,0,0,"DO", 0, 2, 0);
	T = trans[ 3][3] = settr(1606,2,0,0,0,"ATOMIC", 1, 2, 0);
	T->nxt	= settr(1606,2,1,0,0,"ATOMIC", 1, 2, 0);
	trans[3][1]	= settr(1604,0,6,3,3,"(!((!(((STUDENTexTrace&(1<<C1_bo.id))&&(choose1==1)))||((C1_bo.prohib==1)&&(C1_bo.role_pl==STUDENT)))))", 1, 2, 0); /* m: 2 -> 6,0 */
	reached3[2] = 1;
	trans[3][2]	= settr(0,0,0,0,0,"assert(!(!((!(((STUDENTexTrace&(1<<C1_bo.id))&&(choose1==1)))||((C1_bo.prohib==1)&&(C1_bo.role_pl==STUDENT))))))",0,0,0);
	trans[3][4]	= settr(1607,0,6,1,0,"(1)", 0, 2, 0);
	trans[3][5]	= settr(1608,0,6,1,0,"goto T0_init", 0, 2, 0);
	trans[3][8]	= settr(1611,0,9,1,0,"break", 0, 2, 0);
	trans[3][9]	= settr(1612,0,10,1,0,"(1)", 0, 2, 0);
	trans[3][10]	= settr(1613,0,0,4,4,"-end-", 0, 3500, 0);
	...
	trans[2][1]	= settr(1600,2,2,5,5,"(run LEG())", 0, 2, 0);
	trans[2][2]	= settr(1601,0,4,6,6,"(run CRM())", 0, 2, 0);
	trans[2][4]	= settr(1603,0,0,7,7,"-end-", 0, 3500, 0);

	/* proctype 1: CRM */

	trans[1] = (Trans **) emalloc(745*sizeof(Trans *));

	trans[1][1]	= settr(856,0,741,8,0,"printf('CONTRACT RULE MANAGER')", 0, 2, 0);
	...
	trans[1][2]	= settr(857,0,3,9,0,"(LEG2CRM?[18,S])", 1, 2, 0);
	trans[1][3]	= settr(858,0,69,10,10,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][13]	= settr(868,0,69,1,0,".(goto)", 0, 2, 0);
	trans[1][4]	= settr(859,0,5,11,0,"(LEG2CRM?[18,TO])", 1, 2, 0);
	trans[1][5]	= settr(860,0,69,12,12,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][6]	= settr(861,0,7,13,0,"(LEG2CRM?[18,TF])", 1, 2, 0);
	trans[1][7]	= settr(862,0,69,14,14,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][8]	= settr(863,0,9,15,0,"(LEG2CRM?[18,LF])", 1, 2, 0);
	trans[1][9]	= settr(864,0,69,16,16,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][10]	= settr(865,0,11,17,0,"(LEG2CRM?[18,P])", 1, 2, 0);
	trans[1][11]	= settr(866,0,69,18,18,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][69] = settr(924,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(924,0,15,0,0,"sub-sequence", 0, 2, 0);
	trans[1][15]	= settr(870,0,67,19,19,"printf('Start\\n')", 0, 2, 0); /* m: 16 -> 0,67 */
	reached1[16] = 1;
	...
	trans[1][17]	= settr(872,0,36,20,0,"((((RegReq_bo.right==1)&&((RegReq_bo.role_pl==STUDENT)==1))&&((RegReq_bo.status==S)==1)))", 1, 2, 0);
	T = trans[ 1][36] = settr(891,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(891,0,18,0,0,"sub-sequence", 0, 2, 0);
	trans[1][18]	= settr(873,0,25,21,21,"STUDENTexTrace = (STUDENTexTrace&(1<<RegReq_bo.id))", 1, 2, 0);
	T = trans[ 1][25] = settr(880,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(880,2,19,0,0,"ATOMIC", 0, 2, 0);
	trans[1][19]	= settr(874,4,29,22,22,"printf('\\n\\n')", 0, 2, 0); /* m: 20 -> 0,29 */
	reached1[20] = 1;
	...
	trans[1][26]	= settr(881,0,27,23,23,"RegReply_bo.oblig = 1", 1, 2, 0);
	trans[1][27]	= settr(882,0,28,24,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.prohib==1))))", 1, 2, 0);
	trans[1][28]	= settr(883,0,33,25,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][33] = settr(888,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(888,0,30,0,0,"sub-sequence", 0, 2, 0);
	trans[1][30]	= settr(885,0,31,26,26,"RegReq_bo.right = 0", 1, 2, 0);
	trans[1][31]	= settr(886,0,32,27,0,"assert(!(((RegReq_bo.right==1)&&(RegReq_bo.oblig==1))))", 1, 2, 0);
	trans[1][32]	= settr(887,0,35,28,0,"assert(!(((RegReq_bo.right==1)&&(RegReq_bo.prohib==1))))", 1, 2, 0);
	T = trans[ 1][35] = settr(890,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(890,0,34,0,0,"sub-sequence", 0, 2, 0);
	trans[1][34]	= settr(889,0,741,29,29,"CRM2LEG!9,5", 1, 4, 0);
	trans[1][68]	= settr(923,0,741,1,0,".(goto)", 0, 2, 0);
	trans[1][37]	= settr(892,0,63,30,0,"((((RegReq_bo.right==1)&&((RegReq_bo.role_pl==STUDENT)==1))&&((RegReq_bo.status==TF)==1)))", 1, 2, 0);
	...
	trans[1][38]	= settr(893,0,49,31,31,"printf('\\n\\n')", 0, 2, 0); /* m: 39 -> 0,49 */
	reached1[39] = 1;
	...
	trans[1][46]	= settr(901,0,47,32,32,"RegReply_bo.oblig = 0", 1, 2, 0);
	trans[1][47]	= settr(902,0,48,33,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.prohib==1))))", 1, 2, 0);
	trans[1][48]	= settr(903,0,53,34,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][53] = settr(908,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(908,0,50,0,0,"sub-sequence", 0, 2, 0);
	trans[1][50]	= settr(905,0,51,35,35,"RegReq_bo.right = 1", 1, 2, 0);
	trans[1][51]	= settr(906,0,52,36,0,"assert(!(((RegReq_bo.right==1)&&(RegReq_bo.oblig==1))))", 1, 2, 0);
	trans[1][52]	= settr(907,0,60,37,0,"assert(!(((RegReq_bo.right==1)&&(RegReq_bo.prohib==1))))", 1, 2, 0);
	T = trans[ 1][60] = settr(915,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(915,2,54,0,0,"ATOMIC", 0, 2, 0);
	trans[1][54]	= settr(909,4,62,38,38,"printf('\\n\\n')", 0, 2, 0); /* m: 55 -> 0,62 */
	reached1[55] = 1;
	...
	trans[1][61]	= settr(916,0,741,39,39,"CRM2LEG!8,5", 1, 4, 0);
	...
	trans[1][65]	= settr(920,0,741,40,40,"CRM2LEG!6,5", 1, 4, 0);
	...
	trans[1][70]	= settr(925,0,71,41,0,"(LEG2CRM?[19,S])", 1, 2, 0);
	trans[1][71]	= settr(926,0,152,42,42,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][81]	= settr(936,0,152,1,0,".(goto)", 0, 2, 0);
	trans[1][72]	= settr(927,0,73,43,0,"(LEG2CRM?[19,TO])", 1, 2, 0);
	trans[1][73]	= settr(928,0,152,44,44,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][74]	= settr(929,0,75,45,0,"(LEG2CRM?[19,TF])", 1, 2, 0);
	trans[1][75]	= settr(930,0,152,46,46,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][76]	= settr(931,0,77,47,0,"(LEG2CRM?[19,LF])", 1, 2, 0);
	trans[1][77]	= settr(932,0,152,48,48,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][78]	= settr(933,0,79,49,0,"(LEG2CRM?[19,P])", 1, 2, 0);
	trans[1][79]	= settr(934,0,152,50,50,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][152] = settr(1007,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1007,0,83,0,0,"sub-sequence", 0, 2, 0);
	trans[1][83]	= settr(938,0,150,51,0,"printf('Course list reply')", 0, 2, 0);
	...
	trans[1][84]	= settr(939,0,111,52,0,"((((RegReply_bo.oblig==1)&&((RegReply_bo.role_pl==LMS)==1))&&((RegReply_bo.status==S)==1)))", 1, 2, 0);
	...
	trans[1][85]	= settr(940,4,92,53,53,"printf('\\n\\n')", 0, 2, 0); /* m: 86 -> 0,92 */
	reached1[86] = 1;
	...
	trans[1][92]	= settr(947,0,96,54,54,"LMSexTrace = (LMSexTrace&(1<<RegReply_bo.id))", 1, 2, 0);
	T = trans[ 1][96] = settr(951,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(951,0,93,0,0,"sub-sequence", 0, 2, 0);
	trans[1][93]	= settr(948,0,94,55,55,"RegReply_bo.oblig = 0", 1, 2, 0);
	trans[1][94]	= settr(949,0,95,56,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.prohib==1))))", 1, 2, 0);
	trans[1][95]	= settr(950,0,100,57,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][100] = settr(955,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(955,0,97,0,0,"sub-sequence", 0, 2, 0);
	trans[1][97]	= settr(952,0,98,58,58,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][98]	= settr(953,0,99,59,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][99]	= settr(954,0,104,60,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][104] = settr(959,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(959,0,101,0,0,"sub-sequence", 0, 2, 0);
	trans[1][101]	= settr(956,0,102,61,61,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][102]	= settr(957,0,103,62,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][103]	= settr(958,0,108,63,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][108] = settr(963,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(963,0,105,0,0,"sub-sequence", 0, 2, 0);
	trans[1][105]	= settr(960,0,106,64,64,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][106]	= settr(961,0,107,65,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][107]	= settr(962,0,110,66,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][110] = settr(965,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(965,0,109,0,0,"sub-sequence", 0, 2, 0);
	trans[1][109]	= settr(964,0,741,67,67,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][151]	= settr(1006,0,741,1,0,".(goto)", 0, 2, 0);
	trans[1][112]	= settr(967,0,146,68,0,"((((RegReply_bo.oblig==1)&&((RegReply_bo.role_pl==LMS)==1))&&((RegReply_bo.status==TF)==1)))", 1, 2, 0);
	...
	trans[1][113]	= settr(968,0,124,69,69,"printf('\\n\\n')", 0, 2, 0); /* m: 114 -> 0,124 */
	reached1[114] = 1;
	...
	trans[1][121]	= settr(976,0,122,70,70,"RegReply_bo.oblig = 1", 1, 2, 0);
	trans[1][122]	= settr(977,0,123,71,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.prohib==1))))", 1, 2, 0);
	trans[1][123]	= settr(978,0,128,72,0,"assert(!(((RegReply_bo.oblig==1)&&(RegReply_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][128] = settr(983,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(983,0,125,0,0,"sub-sequence", 0, 2, 0);
	trans[1][125]	= settr(980,0,126,73,73,"C1_bo.oblig = 0", 1, 2, 0);
	trans[1][126]	= settr(981,0,127,74,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][127]	= settr(982,0,132,75,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][132] = settr(987,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(987,0,129,0,0,"sub-sequence", 0, 2, 0);
	trans[1][129]	= settr(984,0,130,76,76,"C2_bo.oblig = 0", 1, 2, 0);
	trans[1][130]	= settr(985,0,131,77,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][131]	= settr(986,0,136,78,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][136] = settr(991,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(991,0,133,0,0,"sub-sequence", 0, 2, 0);
	trans[1][133]	= settr(988,0,134,79,79,"C3_bo.oblig = 0", 1, 2, 0);
	trans[1][134]	= settr(989,0,135,80,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][135]	= settr(990,0,143,81,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][143] = settr(998,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(998,2,137,0,0,"ATOMIC", 0, 2, 0);
	trans[1][137]	= settr(992,4,145,82,82,"printf('\\n\\n')", 0, 2, 0); /* m: 138 -> 0,145 */
	reached1[138] = 1;
	...
	trans[1][144]	= settr(999,0,741,83,83,"CRM2LEG!8,5", 1, 4, 0);
	...
	trans[1][148]	= settr(1003,0,741,84,84,"CRM2LEG!6,5", 1, 4, 0);
	...
	trans[1][153]	= settr(1008,0,154,85,0,"(LEG2CRM?[20,S])", 1, 2, 0);
	trans[1][154]	= settr(1009,0,242,86,86,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][164]	= settr(1019,0,242,1,0,".(goto)", 0, 2, 0);
	trans[1][155]	= settr(1010,0,156,87,0,"(LEG2CRM?[20,TO])", 1, 2, 0);
	trans[1][156]	= settr(1011,0,242,88,88,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][157]	= settr(1012,0,158,89,0,"(LEG2CRM?[20,TF])", 1, 2, 0);
	trans[1][158]	= settr(1013,0,242,90,90,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][159]	= settr(1014,0,160,91,0,"(LEG2CRM?[20,LF])", 1, 2, 0);
	trans[1][160]	= settr(1015,0,242,92,92,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][161]	= settr(1016,0,162,93,0,"(LEG2CRM?[20,P])", 1, 2, 0);
	trans[1][162]	= settr(1017,0,242,94,94,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][242] = settr(1097,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1097,0,166,0,0,"sub-sequence", 0, 2, 0);
	trans[1][166]	= settr(1021,0,240,95,0,"printf('C1')", 0, 2, 0);
	...
	trans[1][167]	= settr(1022,0,200,96,0,"((((C1_bo.oblig==1)&&((C1_bo.role_pl==STUDENT)==1))&&((C1_bo.status==S)==1)))", 1, 2, 0);
	...
	trans[1][168]	= settr(1023,4,175,97,97,"printf('\\n\\n')", 0, 2, 0); /* m: 169 -> 0,175 */
	reached1[169] = 1;
	...
	trans[1][175]	= settr(1030,0,179,98,98,"STUDENTexTrace = (STUDENTexTrace&(1<<C1_bo.id))", 1, 2, 0);
	T = trans[ 1][179] = settr(1034,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1034,0,176,0,0,"sub-sequence", 0, 2, 0);
	trans[1][176]	= settr(1031,0,177,99,99,"ChooseAccept_bo.oblig = 1", 1, 2, 0);
	trans[1][177]	= settr(1032,0,178,100,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][178]	= settr(1033,0,183,101,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][183] = settr(1038,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1038,0,180,0,0,"sub-sequence", 0, 2, 0);
	trans[1][180]	= settr(1035,0,181,102,102,"ChooseReject_bo.oblig = 1", 1, 2, 0);
	trans[1][181]	= settr(1036,0,182,103,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][182]	= settr(1037,0,187,104,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][187] = settr(1042,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1042,0,184,0,0,"sub-sequence", 0, 2, 0);
	trans[1][184]	= settr(1039,0,185,105,105,"C1_bo.oblig = 0", 1, 2, 0);
	trans[1][185]	= settr(1040,0,186,106,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][186]	= settr(1041,0,191,107,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][191] = settr(1046,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1046,0,188,0,0,"sub-sequence", 0, 2, 0);
	trans[1][188]	= settr(1043,0,189,108,108,"C2_bo.oblig = 0", 1, 2, 0);
	trans[1][189]	= settr(1044,0,190,109,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][190]	= settr(1045,0,195,110,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][195] = settr(1050,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1050,0,192,0,0,"sub-sequence", 0, 2, 0);
	trans[1][192]	= settr(1047,0,193,111,111,"C3_bo.oblig = 0", 1, 2, 0);
	trans[1][193]	= settr(1048,0,194,112,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][194]	= settr(1049,0,196,113,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][196]	= settr(1051,0,197,114,114,"choose1 = 1", 1, 2, 0);
	trans[1][197]	= settr(1052,0,199,115,0,"printf('C1 is chosen')", 0, 2, 0);
	T = trans[ 1][199] = settr(1054,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1054,0,198,0,0,"sub-sequence", 0, 2, 0);
	trans[1][198]	= settr(1053,0,741,116,116,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][241]	= settr(1096,0,741,1,0,".(goto)", 0, 2, 0);
	trans[1][201]	= settr(1056,0,231,117,0,"((((C1_bo.oblig==1)&&((C1_bo.role_pl==STUDENT)==1))&&((C1_bo.status==TF)==1)))", 1, 2, 0);
	...
	trans[1][202]	= settr(1057,0,213,118,118,"printf('\\n\\n')", 0, 2, 0); /* m: 203 -> 0,213 */
	reached1[203] = 1;
	...
	trans[1][210]	= settr(1065,0,211,119,119,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][211]	= settr(1066,0,212,120,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][212]	= settr(1067,0,217,121,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][217] = settr(1072,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1072,0,214,0,0,"sub-sequence", 0, 2, 0);
	trans[1][214]	= settr(1069,0,215,122,122,"ChooseReject_bo.oblig = 0", 1, 2, 0);
	trans[1][215]	= settr(1070,0,216,123,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][216]	= settr(1071,0,221,124,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][221] = settr(1076,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1076,0,218,0,0,"sub-sequence", 0, 2, 0);
	trans[1][218]	= settr(1073,0,219,125,125,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][219]	= settr(1074,0,220,126,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][220]	= settr(1075,0,228,127,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][228] = settr(1083,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1083,2,222,0,0,"ATOMIC", 0, 2, 0);
	trans[1][222]	= settr(1077,4,230,128,128,"printf('\\n\\n')", 0, 2, 0); /* m: 223 -> 0,230 */
	reached1[223] = 1;
	...
	trans[1][229]	= settr(1084,0,741,129,129,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][232]	= settr(1087,0,236,130,0,"((((C1_bo.prohib==1)&&((C1_bo.role_pl==STUDENT)==1))&&((C1_bo.status==P)==1)))", 1, 2, 0);
	T = trans[ 1][236] = settr(1091,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1091,0,233,0,0,"sub-sequence", 0, 2, 0);
	trans[1][233]	= settr(1088,0,235,131,0,"printf('Prohibited choice')", 0, 2, 0);
	T = trans[ 1][235] = settr(1090,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1090,0,234,0,0,"sub-sequence", 0, 2, 0);
	trans[1][234]	= settr(1089,0,741,132,132,"CRM2LEG!7,5", 1, 4, 0);
	...
	trans[1][238]	= settr(1093,0,741,133,133,"CRM2LEG!6,5", 1, 4, 0);
	...
	trans[1][243]	= settr(1098,0,244,134,0,"(LEG2CRM?[21,S])", 1, 2, 0);
	trans[1][244]	= settr(1099,0,332,135,135,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][254]	= settr(1109,0,332,1,0,".(goto)", 0, 2, 0);
	trans[1][245]	= settr(1100,0,246,136,0,"(LEG2CRM?[21,TO])", 1, 2, 0);
	trans[1][246]	= settr(1101,0,332,137,137,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][247]	= settr(1102,0,248,138,0,"(LEG2CRM?[21,TF])", 1, 2, 0);
	trans[1][248]	= settr(1103,0,332,139,139,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][249]	= settr(1104,0,250,140,0,"(LEG2CRM?[21,LF])", 1, 2, 0);
	trans[1][250]	= settr(1105,0,332,141,141,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][251]	= settr(1106,0,252,142,0,"(LEG2CRM?[21,P])", 1, 2, 0);
	trans[1][252]	= settr(1107,0,332,143,143,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][332] = settr(1187,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1187,0,256,0,0,"sub-sequence", 0, 2, 0);
	trans[1][256]	= settr(1111,0,330,144,0,"printf('C2')", 0, 2, 0);
	...
	trans[1][257]	= settr(1112,0,290,145,0,"((((C2_bo.oblig==1)&&((C2_bo.role_pl==STUDENT)==1))&&((C2_bo.status==S)==1)))", 1, 2, 0);
	...
	trans[1][258]	= settr(1113,4,265,146,146,"printf('\\n\\n')", 0, 2, 0); /* m: 259 -> 0,265 */
	reached1[259] = 1;
	...
	trans[1][265]	= settr(1120,0,269,147,147,"STUDENTexTrace = (STUDENTexTrace&(1<<C2_bo.id))", 1, 2, 0);
	T = trans[ 1][269] = settr(1124,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1124,0,266,0,0,"sub-sequence", 0, 2, 0);
	trans[1][266]	= settr(1121,0,267,148,148,"ChooseAccept_bo.oblig = 1", 1, 2, 0);
	trans[1][267]	= settr(1122,0,268,149,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][268]	= settr(1123,0,273,150,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][273] = settr(1128,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1128,0,270,0,0,"sub-sequence", 0, 2, 0);
	trans[1][270]	= settr(1125,0,271,151,151,"ChooseReject_bo.oblig = 1", 1, 2, 0);
	trans[1][271]	= settr(1126,0,272,152,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][272]	= settr(1127,0,277,153,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][277] = settr(1132,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1132,0,274,0,0,"sub-sequence", 0, 2, 0);
	trans[1][274]	= settr(1129,0,275,154,154,"C1_bo.oblig = 0", 1, 2, 0);
	trans[1][275]	= settr(1130,0,276,155,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][276]	= settr(1131,0,281,156,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][281] = settr(1136,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1136,0,278,0,0,"sub-sequence", 0, 2, 0);
	trans[1][278]	= settr(1133,0,279,157,157,"C2_bo.oblig = 0", 1, 2, 0);
	trans[1][279]	= settr(1134,0,280,158,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][280]	= settr(1135,0,285,159,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][285] = settr(1140,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1140,0,282,0,0,"sub-sequence", 0, 2, 0);
	trans[1][282]	= settr(1137,0,283,160,160,"C3_bo.oblig = 0", 1, 2, 0);
	trans[1][283]	= settr(1138,0,284,161,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][284]	= settr(1139,0,286,162,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][286]	= settr(1141,0,287,163,163,"choose2 = 1", 1, 2, 0);
	trans[1][287]	= settr(1142,0,289,164,0,"printf('C2 is chosen')", 0, 2, 0);
	T = trans[ 1][289] = settr(1144,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1144,0,288,0,0,"sub-sequence", 0, 2, 0);
	trans[1][288]	= settr(1143,0,741,165,165,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][331]	= settr(1186,0,741,1,0,".(goto)", 0, 2, 0);
	trans[1][291]	= settr(1146,0,321,166,0,"((((C2_bo.oblig==1)&&((C2_bo.role_pl==STUDENT)==1))&&((C2_bo.status==TF)==1)))", 1, 2, 0);
	...
	trans[1][292]	= settr(1147,0,303,167,167,"printf('\\n\\n')", 0, 2, 0); /* m: 293 -> 0,303 */
	reached1[293] = 1;
	...
	trans[1][300]	= settr(1155,0,301,168,168,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][301]	= settr(1156,0,302,169,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][302]	= settr(1157,0,307,170,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][307] = settr(1162,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1162,0,304,0,0,"sub-sequence", 0, 2, 0);
	trans[1][304]	= settr(1159,0,305,171,171,"ChooseReject_bo.oblig = 0", 1, 2, 0);
	trans[1][305]	= settr(1160,0,306,172,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][306]	= settr(1161,0,311,173,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][311] = settr(1166,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1166,0,308,0,0,"sub-sequence", 0, 2, 0);
	trans[1][308]	= settr(1163,0,309,174,174,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][309]	= settr(1164,0,310,175,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][310]	= settr(1165,0,318,176,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][318] = settr(1173,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1173,2,312,0,0,"ATOMIC", 0, 2, 0);
	trans[1][312]	= settr(1167,4,320,177,177,"printf('\\n\\n')", 0, 2, 0); /* m: 313 -> 0,320 */
	reached1[313] = 1;
	...
	trans[1][319]	= settr(1174,0,741,178,178,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][322]	= settr(1177,0,326,179,0,"((((C2_bo.prohib==1)&&((C2_bo.role_pl==STUDENT)==1))&&((C2_bo.status==P)==1)))", 1, 2, 0);
	T = trans[ 1][326] = settr(1181,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1181,0,323,0,0,"sub-sequence", 0, 2, 0);
	trans[1][323]	= settr(1178,0,325,180,0,"printf('Prohibited choice')", 0, 2, 0);
	T = trans[ 1][325] = settr(1180,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1180,0,324,0,0,"sub-sequence", 0, 2, 0);
	trans[1][324]	= settr(1179,0,741,181,181,"CRM2LEG!7,5", 1, 4, 0);
	...
	trans[1][328]	= settr(1183,0,741,182,182,"CRM2LEG!6,5", 1, 4, 0);
	...
	trans[1][333]	= settr(1188,0,334,183,0,"(LEG2CRM?[22,S])", 1, 2, 0);
	trans[1][334]	= settr(1189,0,422,184,184,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][344]	= settr(1199,0,422,1,0,".(goto)", 0, 2, 0);
	trans[1][335]	= settr(1190,0,336,185,0,"(LEG2CRM?[22,TO])", 1, 2, 0);
	trans[1][336]	= settr(1191,0,422,186,186,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][337]	= settr(1192,0,338,187,0,"(LEG2CRM?[22,TF])", 1, 2, 0);
	trans[1][338]	= settr(1193,0,422,188,188,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][339]	= settr(1194,0,340,189,0,"(LEG2CRM?[22,LF])", 1, 2, 0);
	trans[1][340]	= settr(1195,0,422,190,190,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][341]	= settr(1196,0,342,191,0,"(LEG2CRM?[22,P])", 1, 2, 0);
	trans[1][342]	= settr(1197,0,422,192,192,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][422] = settr(1277,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1277,0,346,0,0,"sub-sequence", 0, 2, 0);
	trans[1][346]	= settr(1201,0,420,193,0,"printf('C3')", 0, 2, 0);
	...
	trans[1][347]	= settr(1202,0,380,194,0,"((((C3_bo.oblig==1)&&((C3_bo.role_pl==STUDENT)==1))&&((C3_bo.status==S)==1)))", 1, 2, 0);
	...
	trans[1][348]	= settr(1203,4,355,195,195,"printf('\\n\\n')", 0, 2, 0); /* m: 349 -> 0,355 */
	reached1[349] = 1;
	...
	trans[1][355]	= settr(1210,0,359,196,196,"STUDENTexTrace = (STUDENTexTrace&(1<<C3_bo.id))", 1, 2, 0);
	T = trans[ 1][359] = settr(1214,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1214,0,356,0,0,"sub-sequence", 0, 2, 0);
	trans[1][356]	= settr(1211,0,357,197,197,"ChooseAccept_bo.oblig = 1", 1, 2, 0);
	trans[1][357]	= settr(1212,0,358,198,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][358]	= settr(1213,0,363,199,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][363] = settr(1218,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1218,0,360,0,0,"sub-sequence", 0, 2, 0);
	trans[1][360]	= settr(1215,0,361,200,200,"ChooseReject_bo.oblig = 1", 1, 2, 0);
	trans[1][361]	= settr(1216,0,362,201,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][362]	= settr(1217,0,367,202,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][367] = settr(1222,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1222,0,364,0,0,"sub-sequence", 0, 2, 0);
	trans[1][364]	= settr(1219,0,365,203,203,"C1_bo.oblig = 0", 1, 2, 0);
	trans[1][365]	= settr(1220,0,366,204,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][366]	= settr(1221,0,371,205,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][371] = settr(1226,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1226,0,368,0,0,"sub-sequence", 0, 2, 0);
	trans[1][368]	= settr(1223,0,369,206,206,"C2_bo.oblig = 0", 1, 2, 0);
	trans[1][369]	= settr(1224,0,370,207,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][370]	= settr(1225,0,375,208,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][375] = settr(1230,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1230,0,372,0,0,"sub-sequence", 0, 2, 0);
	trans[1][372]	= settr(1227,0,373,209,209,"C3_bo.oblig = 0", 1, 2, 0);
	trans[1][373]	= settr(1228,0,374,210,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][374]	= settr(1229,0,376,211,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][376]	= settr(1231,0,377,212,212,"choose3 = 1", 1, 2, 0);
	trans[1][377]	= settr(1232,0,379,213,0,"printf('C3 is chosen')", 0, 2, 0);
	T = trans[ 1][379] = settr(1234,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1234,0,378,0,0,"sub-sequence", 0, 2, 0);
	trans[1][378]	= settr(1233,0,741,214,214,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][421]	= settr(1276,0,741,1,0,".(goto)", 0, 2, 0);
	trans[1][381]	= settr(1236,0,411,215,0,"((((C3_bo.oblig==1)&&((C3_bo.role_pl==STUDENT)==1))&&((C3_bo.status==TF)==1)))", 1, 2, 0);
	...
	trans[1][382]	= settr(1237,0,393,216,216,"printf('\\n\\n')", 0, 2, 0); /* m: 383 -> 0,393 */
	reached1[383] = 1;
	...
	trans[1][390]	= settr(1245,0,391,217,217,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][391]	= settr(1246,0,392,218,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][392]	= settr(1247,0,397,219,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][397] = settr(1252,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1252,0,394,0,0,"sub-sequence", 0, 2, 0);
	trans[1][394]	= settr(1249,0,395,220,220,"ChooseReject_bo.oblig = 0", 1, 2, 0);
	trans[1][395]	= settr(1250,0,396,221,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][396]	= settr(1251,0,401,222,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][401] = settr(1256,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1256,0,398,0,0,"sub-sequence", 0, 2, 0);
	trans[1][398]	= settr(1253,0,399,223,223,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][399]	= settr(1254,0,400,224,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][400]	= settr(1255,0,408,225,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][408] = settr(1263,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1263,2,402,0,0,"ATOMIC", 0, 2, 0);
	trans[1][402]	= settr(1257,4,410,226,226,"printf('\\n\\n')", 0, 2, 0); /* m: 403 -> 0,410 */
	reached1[403] = 1;
	...
	trans[1][409]	= settr(1264,0,741,227,227,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][412]	= settr(1267,0,416,228,0,"((((C3_bo.prohib==1)&&((C3_bo.role_pl==STUDENT)==1))&&((C3_bo.status==P)==1)))", 1, 2, 0);
	T = trans[ 1][416] = settr(1271,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1271,0,413,0,0,"sub-sequence", 0, 2, 0);
	trans[1][413]	= settr(1268,0,415,229,0,"printf('Prohibited choice')", 0, 2, 0);
	T = trans[ 1][415] = settr(1270,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1270,0,414,0,0,"sub-sequence", 0, 2, 0);
	trans[1][414]	= settr(1269,0,741,230,230,"CRM2LEG!7,5", 1, 4, 0);
	...
	trans[1][418]	= settr(1273,0,741,231,231,"CRM2LEG!6,5", 1, 4, 0);
	...
	trans[1][423]	= settr(1278,0,424,232,0,"(LEG2CRM?[23,S])", 1, 2, 0);
	trans[1][424]	= settr(1279,0,492,233,233,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][434]	= settr(1289,0,492,1,0,".(goto)", 0, 2, 0);
	trans[1][425]	= settr(1280,0,426,234,0,"(LEG2CRM?[23,TO])", 1, 2, 0);
	trans[1][426]	= settr(1281,0,492,235,235,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][427]	= settr(1282,0,428,236,0,"(LEG2CRM?[23,TF])", 1, 2, 0);
	trans[1][428]	= settr(1283,0,492,237,237,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][429]	= settr(1284,0,430,238,0,"(LEG2CRM?[23,LF])", 1, 2, 0);
	trans[1][430]	= settr(1285,0,492,239,239,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][431]	= settr(1286,0,432,240,0,"(LEG2CRM?[23,P])", 1, 2, 0);
	trans[1][432]	= settr(1287,0,492,241,241,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][492] = settr(1347,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1347,0,436,0,0,"sub-sequence", 0, 2, 0);
	trans[1][436]	= settr(1291,0,490,242,0,"printf('Accept the choice ')", 0, 2, 0);
	...
	trans[1][437]	= settr(1292,0,459,243,0,"((((ChooseAccept_bo.oblig==1)&&((ChooseAccept_bo.role_pl==LMS)==1))&&((ChooseAccept_bo.status==S)==1)))", 1, 2, 0);
	...
	trans[1][438]	= settr(1293,4,445,244,244,"printf('\\n\\n')", 0, 2, 0); /* m: 439 -> 0,445 */
	reached1[439] = 1;
	...
	trans[1][445]	= settr(1300,0,449,245,245,"LMSexTrace = (LMSexTrace&(1<<ChooseAccept_bo.id))", 1, 2, 0);
	T = trans[ 1][449] = settr(1304,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1304,0,446,0,0,"sub-sequence", 0, 2, 0);
	trans[1][446]	= settr(1301,0,447,246,246,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][447]	= settr(1302,0,448,247,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][448]	= settr(1303,0,456,248,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][456] = settr(1311,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1311,2,450,0,0,"ATOMIC", 0, 2, 0);
	trans[1][450]	= settr(1305,4,458,249,249,"printf('\\n\\n')", 0, 2, 0); /* m: 451 -> 0,458 */
	reached1[451] = 1;
	...
	trans[1][457]	= settr(1312,0,741,250,250,"CRM2LEG!8,2", 1, 4, 0);
	trans[1][491]	= settr(1346,0,741,1,0,".(goto)", 0, 2, 0);
	trans[1][460]	= settr(1315,0,486,251,0,"((((ChooseAccept_bo.oblig==1)&&((ChooseAccept_bo.role_pl==LMS)==1))&&((ChooseAccept_bo.status==TF)==1)))", 1, 2, 0);
	...
	trans[1][461]	= settr(1316,0,472,252,252,"printf('\\n\\n')", 0, 2, 0); /* m: 462 -> 0,472 */
	reached1[462] = 1;
	...
	trans[1][469]	= settr(1324,0,470,253,253,"ChooseAccept_bo.oblig = 1", 1, 2, 0);
	trans[1][470]	= settr(1325,0,471,254,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][471]	= settr(1326,0,476,255,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][476] = settr(1331,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1331,0,473,0,0,"sub-sequence", 0, 2, 0);
	trans[1][473]	= settr(1328,0,474,256,256,"ChooseReject_bo.oblig = 1", 1, 2, 0);
	trans[1][474]	= settr(1329,0,475,257,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][475]	= settr(1330,0,483,258,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][483] = settr(1338,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1338,2,477,0,0,"ATOMIC", 0, 2, 0);
	trans[1][477]	= settr(1332,4,485,259,259,"printf('\\n\\n')", 0, 2, 0); /* m: 478 -> 0,485 */
	reached1[478] = 1;
	...
	trans[1][484]	= settr(1339,0,741,260,260,"CRM2LEG!8,5", 1, 4, 0);
	...
	trans[1][488]	= settr(1343,0,741,261,261,"CRM2LEG!6,5", 1, 4, 0);
	...
	trans[1][493]	= settr(1348,0,494,262,0,"(LEG2CRM?[24,S])", 1, 2, 0);
	trans[1][494]	= settr(1349,0,740,263,263,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][504]	= settr(1359,0,740,1,0,".(goto)", 0, 2, 0);
	trans[1][495]	= settr(1350,0,496,264,0,"(LEG2CRM?[24,TO])", 1, 2, 0);
	trans[1][496]	= settr(1351,0,740,265,265,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][497]	= settr(1352,0,498,266,0,"(LEG2CRM?[24,TF])", 1, 2, 0);
	trans[1][498]	= settr(1353,0,740,267,267,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][499]	= settr(1354,0,500,268,0,"(LEG2CRM?[24,LF])", 1, 2, 0);
	trans[1][500]	= settr(1355,0,740,269,269,"LEG2CRM?_,_", 1, 503, 0);
	trans[1][501]	= settr(1356,0,502,270,0,"(LEG2CRM?[24,P])", 1, 2, 0);
	trans[1][502]	= settr(1357,0,740,271,271,"LEG2CRM?_,_", 1, 503, 0);
	T = trans[ 1][740] = settr(1595,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1595,0,506,0,0,"sub-sequence", 0, 2, 0);
	trans[1][506]	= settr(1361,0,738,272,0,"printf('Reject the choice ')", 0, 2, 0);
	...
	trans[1][507]	= settr(1362,0,707,273,0,"((((ChooseReject_bo.oblig==1)&&((ChooseReject_bo.role_pl==LMS)==1))&&((ChooseReject_bo.status==S)==1)))", 1, 2, 0);
	...
	trans[1][508]	= settr(1363,4,515,274,274,"printf('\\n\\n')", 0, 2, 0); /* m: 509 -> 0,515 */
	reached1[509] = 1;
	...
	trans[1][515]	= settr(1370,0,519,275,275,"LMSexTrace = (LMSexTrace&(1<<ChooseReject_bo.id))", 1, 2, 0);
	T = trans[ 1][519] = settr(1374,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1374,0,516,0,0,"sub-sequence", 0, 2, 0);
	trans[1][516]	= settr(1371,0,517,276,276,"ChooseReject_bo.oblig = 0", 1, 2, 0);
	trans[1][517]	= settr(1372,0,518,277,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][518]	= settr(1373,0,523,278,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][523] = settr(1378,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1378,0,520,0,0,"sub-sequence", 0, 2, 0);
	trans[1][520]	= settr(1375,0,521,279,279,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][521]	= settr(1376,0,522,280,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][522]	= settr(1377,0,689,281,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	...
	trans[1][524]	= settr(1379,0,528,282,0,"((choose1==1))", 1, 2, 0);
	T = trans[ 1][528] = settr(1383,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1383,0,525,0,0,"sub-sequence", 0, 2, 0);
	trans[1][525]	= settr(1380,0,526,283,283,"C1_bo.prohib = 1", 1, 2, 0);
	trans[1][526]	= settr(1381,0,527,284,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][527]	= settr(1382,0,552,285,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][552] = settr(1407,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1407,0,529,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1407,0,547,0,0,"IF", 0, 2, 0);
	trans[1][529]	= settr(1384,0,533,286,0,"((choose2==1))", 1, 2, 0);
	T = trans[ 1][533] = settr(1388,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1388,0,530,0,0,"sub-sequence", 0, 2, 0);
	trans[1][530]	= settr(1385,0,531,287,287,"C2_bo.prohib = 1", 1, 2, 0);
	trans[1][531]	= settr(1386,0,532,288,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][532]	= settr(1387,0,545,289,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][545] = settr(1400,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1400,0,534,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1400,0,540,0,0,"IF", 0, 2, 0);
	trans[1][534]	= settr(1389,0,538,290,0,"((choose3==1))", 1, 2, 0);
	T = trans[ 1][538] = settr(1393,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1393,0,535,0,0,"sub-sequence", 0, 2, 0);
	trans[1][535]	= settr(1390,0,536,291,291,"C3_bo.prohib = 1", 1, 2, 0);
	trans[1][536]	= settr(1391,0,537,292,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][537]	= settr(1392,0,539,293,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.oblig==1))))", 1, 2, 0);
	trans[1][539]	= settr(1394,0,577,294,294,"all = 1", 1, 2, 0);
	...
	trans[1][541]	= settr(1396,0,542,295,295,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][542]	= settr(1397,0,543,296,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][543]	= settr(1398,0,577,297,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	...
	trans[1][548]	= settr(1403,0,549,298,298,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][549]	= settr(1404,0,550,299,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][550]	= settr(1405,0,577,300,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[1][577] = settr(1432,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1432,0,554,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1432,0,572,0,0,"IF", 0, 2, 0);
	trans[1][554]	= settr(1409,0,558,301,0,"((choose3==1))", 1, 2, 0);
	T = trans[ 1][558] = settr(1413,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1413,0,555,0,0,"sub-sequence", 0, 2, 0);
	trans[1][555]	= settr(1410,0,556,302,302,"C3_bo.prohib = 1", 1, 2, 0);
	trans[1][556]	= settr(1411,0,557,303,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][557]	= settr(1412,0,570,304,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][570] = settr(1425,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1425,0,559,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1425,0,565,0,0,"IF", 0, 2, 0);
	trans[1][559]	= settr(1414,0,563,305,0,"((choose2==1))", 1, 2, 0);
	T = trans[ 1][563] = settr(1418,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1418,0,560,0,0,"sub-sequence", 0, 2, 0);
	trans[1][560]	= settr(1415,0,561,306,306,"C2_bo.prohib = 1", 1, 2, 0);
	trans[1][561]	= settr(1416,0,562,307,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][562]	= settr(1417,0,564,308,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.oblig==1))))", 1, 2, 0);
	trans[1][564]	= settr(1419,0,697,309,309,"all = 1", 1, 2, 0);
	...
	trans[1][566]	= settr(1421,0,567,310,310,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][567]	= settr(1422,0,568,311,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][568]	= settr(1423,0,697,312,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	...
	trans[1][573]	= settr(1428,0,574,313,313,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][574]	= settr(1429,0,575,314,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][575]	= settr(1430,0,697,315,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][690]	= settr(1545,0,697,1,0,".(goto)", 0, 2, 0);
	trans[1][579]	= settr(1434,0,583,316,0,"((choose2==1))", 1, 2, 0);
	T = trans[ 1][583] = settr(1438,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1438,0,580,0,0,"sub-sequence", 0, 2, 0);
	trans[1][580]	= settr(1435,0,581,317,317,"C2_bo.prohib = 1", 1, 2, 0);
	trans[1][581]	= settr(1436,0,582,318,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][582]	= settr(1437,0,607,319,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][607] = settr(1462,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1462,0,584,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1462,0,602,0,0,"IF", 0, 2, 0);
	trans[1][584]	= settr(1439,0,588,320,0,"((choose1==1))", 1, 2, 0);
	T = trans[ 1][588] = settr(1443,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1443,0,585,0,0,"sub-sequence", 0, 2, 0);
	trans[1][585]	= settr(1440,0,586,321,321,"C1_bo.prohib = 1", 1, 2, 0);
	trans[1][586]	= settr(1441,0,587,322,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][587]	= settr(1442,0,600,323,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][600] = settr(1455,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1455,0,589,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1455,0,595,0,0,"IF", 0, 2, 0);
	trans[1][589]	= settr(1444,0,593,324,0,"((choose3==1))", 1, 2, 0);
	T = trans[ 1][593] = settr(1448,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1448,0,590,0,0,"sub-sequence", 0, 2, 0);
	trans[1][590]	= settr(1445,0,591,325,325,"C3_bo.prohib = 1", 1, 2, 0);
	trans[1][591]	= settr(1446,0,592,326,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][592]	= settr(1447,0,594,327,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.oblig==1))))", 1, 2, 0);
	trans[1][594]	= settr(1449,0,632,328,328,"all = 1", 1, 2, 0);
	...
	trans[1][596]	= settr(1451,0,597,329,329,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][597]	= settr(1452,0,598,330,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][598]	= settr(1453,0,632,331,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	...
	trans[1][603]	= settr(1458,0,604,332,332,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][604]	= settr(1459,0,605,333,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][605]	= settr(1460,0,632,334,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[1][632] = settr(1487,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1487,0,609,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1487,0,627,0,0,"IF", 0, 2, 0);
	trans[1][609]	= settr(1464,0,613,335,0,"((choose3==1))", 1, 2, 0);
	T = trans[ 1][613] = settr(1468,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1468,0,610,0,0,"sub-sequence", 0, 2, 0);
	trans[1][610]	= settr(1465,0,611,336,336,"C3_bo.prohib = 1", 1, 2, 0);
	trans[1][611]	= settr(1466,0,612,337,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][612]	= settr(1467,0,625,338,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][625] = settr(1480,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1480,0,614,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1480,0,620,0,0,"IF", 0, 2, 0);
	trans[1][614]	= settr(1469,0,618,339,0,"((choose1==1))", 1, 2, 0);
	T = trans[ 1][618] = settr(1473,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1473,0,615,0,0,"sub-sequence", 0, 2, 0);
	trans[1][615]	= settr(1470,0,616,340,340,"C1_bo.prohib = 1", 1, 2, 0);
	trans[1][616]	= settr(1471,0,617,341,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][617]	= settr(1472,0,619,342,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.oblig==1))))", 1, 2, 0);
	trans[1][619]	= settr(1474,0,697,343,343,"all = 1", 1, 2, 0);
	...
	trans[1][621]	= settr(1476,0,622,344,344,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][622]	= settr(1477,0,623,345,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][623]	= settr(1478,0,697,346,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	...
	trans[1][628]	= settr(1483,0,629,347,347,"C3_bo.oblig = 1", 1, 2, 0);
	trans[1][629]	= settr(1484,0,630,348,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.prohib==1))))", 1, 2, 0);
	trans[1][630]	= settr(1485,0,697,349,0,"assert(!(((C3_bo.oblig==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][634]	= settr(1489,0,638,350,0,"((choose3==1))", 1, 2, 0);
	T = trans[ 1][638] = settr(1493,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1493,0,635,0,0,"sub-sequence", 0, 2, 0);
	trans[1][635]	= settr(1490,0,636,351,351,"C3_bo.prohib = 1", 1, 2, 0);
	trans[1][636]	= settr(1491,0,637,352,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.right==1))))", 1, 2, 0);
	trans[1][637]	= settr(1492,0,662,353,0,"assert(!(((C3_bo.prohib==1)&&(C3_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][662] = settr(1517,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1517,0,639,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1517,0,657,0,0,"IF", 0, 2, 0);
	trans[1][639]	= settr(1494,0,643,354,0,"((choose2==1))", 1, 2, 0);
	T = trans[ 1][643] = settr(1498,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1498,0,640,0,0,"sub-sequence", 0, 2, 0);
	trans[1][640]	= settr(1495,0,641,355,355,"C2_bo.prohib = 1", 1, 2, 0);
	trans[1][641]	= settr(1496,0,642,356,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][642]	= settr(1497,0,655,357,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][655] = settr(1510,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1510,0,644,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1510,0,650,0,0,"IF", 0, 2, 0);
	trans[1][644]	= settr(1499,0,648,358,0,"((choose1==1))", 1, 2, 0);
	T = trans[ 1][648] = settr(1503,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1503,0,645,0,0,"sub-sequence", 0, 2, 0);
	trans[1][645]	= settr(1500,0,646,359,359,"C1_bo.prohib = 1", 1, 2, 0);
	trans[1][646]	= settr(1501,0,647,360,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][647]	= settr(1502,0,649,361,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.oblig==1))))", 1, 2, 0);
	trans[1][649]	= settr(1504,0,687,362,362,"all = 1", 1, 2, 0);
	...
	trans[1][651]	= settr(1506,0,652,363,363,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][652]	= settr(1507,0,653,364,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][653]	= settr(1508,0,687,365,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	...
	trans[1][658]	= settr(1513,0,659,366,366,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][659]	= settr(1514,0,660,367,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][660]	= settr(1515,0,687,368,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	T = trans[1][687] = settr(1542,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1542,0,664,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1542,0,682,0,0,"IF", 0, 2, 0);
	trans[1][664]	= settr(1519,0,668,369,0,"((choose1==1))", 1, 2, 0);
	T = trans[ 1][668] = settr(1523,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1523,0,665,0,0,"sub-sequence", 0, 2, 0);
	trans[1][665]	= settr(1520,0,666,370,370,"C1_bo.prohib = 1", 1, 2, 0);
	trans[1][666]	= settr(1521,0,667,371,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.right==1))))", 1, 2, 0);
	trans[1][667]	= settr(1522,0,680,372,0,"assert(!(((C1_bo.prohib==1)&&(C1_bo.oblig==1))))", 1, 2, 0);
	T = trans[1][680] = settr(1535,0,0,0,0,"IF", 0, 2, 0);
	T = T->nxt	= settr(1535,0,669,0,0,"IF", 0, 2, 0);
	    T->nxt	= settr(1535,0,675,0,0,"IF", 0, 2, 0);
	trans[1][669]	= settr(1524,0,673,373,0,"((choose2==1))", 1, 2, 0);
	T = trans[ 1][673] = settr(1528,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1528,0,670,0,0,"sub-sequence", 0, 2, 0);
	trans[1][670]	= settr(1525,0,671,374,374,"C2_bo.prohib = 1", 1, 2, 0);
	trans[1][671]	= settr(1526,0,672,375,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.right==1))))", 1, 2, 0);
	trans[1][672]	= settr(1527,0,674,376,0,"assert(!(((C2_bo.prohib==1)&&(C2_bo.oblig==1))))", 1, 2, 0);
	trans[1][674]	= settr(1529,0,697,377,377,"all = 1", 1, 2, 0);
	...
	trans[1][676]	= settr(1531,0,677,378,378,"C2_bo.oblig = 1", 1, 2, 0);
	trans[1][677]	= settr(1532,0,678,379,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.prohib==1))))", 1, 2, 0);
	trans[1][678]	= settr(1533,0,697,380,0,"assert(!(((C2_bo.oblig==1)&&(C2_bo.right==1))))", 1, 2, 0);
	...
	trans[1][683]	= settr(1538,0,684,381,381,"C1_bo.oblig = 1", 1, 2, 0);
	trans[1][684]	= settr(1539,0,685,382,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.prohib==1))))", 1, 2, 0);
	trans[1][685]	= settr(1540,0,697,383,0,"assert(!(((C1_bo.oblig==1)&&(C1_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][697] = settr(1552,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1552,2,691,0,0,"ATOMIC", 0, 2, 0);
	trans[1][691]	= settr(1546,4,705,384,384,"printf('\\n\\n')", 0, 2, 0); /* m: 692 -> 0,705 */
	reached1[692] = 1;
	...
	trans[1][698]	= settr(1553,0,699,385,0,"((all==1))", 1, 2, 0);
	trans[1][699]	= settr(1554,0,701,386,0,"printf('No course is suitable for you')", 0, 2, 0);
	T = trans[ 1][701] = settr(1556,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1556,0,700,0,0,"sub-sequence", 0, 2, 0);
	trans[1][700]	= settr(1555,0,741,387,387,"CRM2LEG!8,2", 1, 4, 0);
	...
	trans[1][703]	= settr(1558,0,741,388,388,"CRM2LEG!8,5", 1, 4, 0);
	trans[1][739]	= settr(1594,0,741,1,0,".(goto)", 0, 2, 0);
	trans[1][708]	= settr(1563,0,734,389,0,"((((ChooseReject_bo.oblig==1)&&((ChooseReject_bo.role_pl==LMS)==1))&&((ChooseReject_bo.status==TF)==1)))", 1, 2, 0);
	...
	trans[1][709]	= settr(1564,0,720,390,390,"printf('\\n\\n')", 0, 2, 0); /* m: 710 -> 0,720 */
	reached1[710] = 1;
	...
	trans[1][717]	= settr(1572,0,718,391,391,"ChooseAccept_bo.oblig = 0", 1, 2, 0);
	trans[1][718]	= settr(1573,0,719,392,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.prohib==1))))", 1, 2, 0);
	trans[1][719]	= settr(1574,0,724,393,0,"assert(!(((ChooseAccept_bo.oblig==1)&&(ChooseAccept_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][724] = settr(1579,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(1579,0,721,0,0,"sub-sequence", 0, 2, 0);
	trans[1][721]	= settr(1576,0,722,394,394,"ChooseReject_bo.oblig = 1", 1, 2, 0);
	trans[1][722]	= settr(1577,0,723,395,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.prohib==1))))", 1, 2, 0);
	trans[1][723]	= settr(1578,0,731,396,0,"assert(!(((ChooseReject_bo.oblig==1)&&(ChooseReject_bo.right==1))))", 1, 2, 0);
	T = trans[ 1][731] = settr(1586,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1586,2,725,0,0,"ATOMIC", 0, 2, 0);
	trans[1][725]	= settr(1580,4,733,397,397,"printf('\\n\\n')", 0, 2, 0); /* m: 726 -> 0,733 */
	reached1[726] = 1;
	...
	trans[1][732]	= settr(1587,0,741,398,398,"CRM2LEG!8,5", 1, 4, 0);
	...
	trans[1][736]	= settr(1591,0,741,399,399,"CRM2LEG!6,5", 1, 4, 0);
	trans[1][743]	= settr(1598,0,744,1,0,"break", 0, 2, 0);
	trans[1][744]	= settr(1599,0,0,400,400,"-end-", 0, 3500, 0);
...
/*->*/	trans[0][68]	= settr(67,32,853,411,411,"D_STEP174", 1, 2, 0);
	...
	trans[0][71]	= settr(70,0,72,412,0,"((((RegReq_bo.right==1)||(RegReq_bo.oblig==1))||(RegReq_bo.prohib==1)))", 1, 2, 0);
	trans[0][72]	= settr(71,0,74,413,413,"RegReq_bo.status = S", 1, 2, 0);
	T = trans[ 0][74] = settr(73,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(73,0,73,0,0,"sub-sequence", 0, 2, 0);
	trans[0][73]	= settr(72,0,116,414,414,"LEG2CRM!18,17", 1, 3, 0);
	...
	trans[0][75]	= settr(74,0,77,415,415,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][78]	= settr(77,0,80,416,416,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][81]	= settr(80,0,83,417,417,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][84]	= settr(83,0,86,418,418,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][87]	= settr(86,0,70,419,419,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][90]	= settr(89,0,70,420,420,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][93]	= settr(92,0,70,421,421,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][96]	= settr(95,0,70,422,422,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][99]	= settr(98,0,70,423,423,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][102]	= settr(101,0,70,424,424,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][105]	= settr(104,0,853,425,425,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][108]	= settr(107,0,853,426,426,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][111]	= settr(110,0,853,427,427,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][113]	= settr(112,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][117]	= settr(116,0,118,428,0,"((((RegReq_bo.right==1)||(RegReq_bo.oblig==1))||(RegReq_bo.prohib==1)))", 1, 2, 0);
	trans[0][118]	= settr(117,0,120,429,429,"RegReq_bo.status = TF", 1, 2, 0);
	T = trans[ 0][120] = settr(119,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(119,0,119,0,0,"sub-sequence", 0, 2, 0);
	trans[0][119]	= settr(118,0,162,430,430,"LEG2CRM!18,15", 1, 3, 0);
	...
	trans[0][121]	= settr(120,0,123,431,431,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][124]	= settr(123,0,126,432,432,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][127]	= settr(126,0,129,433,433,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][130]	= settr(129,0,132,434,434,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][133]	= settr(132,0,70,435,435,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][136]	= settr(135,0,70,436,436,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][139]	= settr(138,0,70,437,437,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][142]	= settr(141,0,70,438,438,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][145]	= settr(144,0,70,439,439,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][148]	= settr(147,0,70,440,440,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][151]	= settr(150,0,853,441,441,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][154]	= settr(153,0,853,442,442,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][157]	= settr(156,0,853,443,443,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][159]	= settr(158,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][163]	= settr(162,0,164,444,0,"((((RegReply_bo.right==1)||(RegReply_bo.oblig==1))||(RegReply_bo.prohib==1)))", 1, 2, 0);
	trans[0][164]	= settr(163,0,166,445,445,"RegReply_bo.status = S", 1, 2, 0);
	T = trans[ 0][166] = settr(165,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(165,0,165,0,0,"sub-sequence", 0, 2, 0);
	trans[0][165]	= settr(164,0,208,446,446,"LEG2CRM!19,17", 1, 3, 0);
	...
	trans[0][167]	= settr(166,0,169,447,447,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][170]	= settr(169,0,172,448,448,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][173]	= settr(172,0,175,449,449,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][176]	= settr(175,0,178,450,450,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][179]	= settr(178,0,70,451,451,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][182]	= settr(181,0,70,452,452,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][185]	= settr(184,0,70,453,453,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][188]	= settr(187,0,70,454,454,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][191]	= settr(190,0,70,455,455,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][194]	= settr(193,0,70,456,456,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][197]	= settr(196,0,853,457,457,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][200]	= settr(199,0,853,458,458,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][203]	= settr(202,0,853,459,459,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][205]	= settr(204,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][209]	= settr(208,0,210,460,0,"((((RegReply_bo.right==1)||(RegReply_bo.oblig==1))||(RegReply_bo.prohib==1)))", 1, 2, 0);
	trans[0][210]	= settr(209,0,212,461,461,"RegReply_bo.status = TF", 1, 2, 0);
	T = trans[ 0][212] = settr(211,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(211,0,211,0,0,"sub-sequence", 0, 2, 0);
	trans[0][211]	= settr(210,0,254,462,462,"LEG2CRM!19,15", 1, 3, 0);
	...
	trans[0][213]	= settr(212,0,215,463,463,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][216]	= settr(215,0,218,464,464,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][219]	= settr(218,0,221,465,465,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][222]	= settr(221,0,224,466,466,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][225]	= settr(224,0,70,467,467,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][228]	= settr(227,0,70,468,468,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][231]	= settr(230,0,70,469,469,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][234]	= settr(233,0,70,470,470,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][237]	= settr(236,0,70,471,471,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][240]	= settr(239,0,70,472,472,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][243]	= settr(242,0,853,473,473,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][246]	= settr(245,0,853,474,474,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][249]	= settr(248,0,853,475,475,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][251]	= settr(250,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][255]	= settr(254,0,256,476,0,"((((C1_bo.right==1)||(C1_bo.oblig==1))||(C1_bo.prohib==1)))", 1, 2, 0);
	trans[0][256]	= settr(255,0,258,477,477,"C1_bo.status = S", 1, 2, 0);
	T = trans[ 0][258] = settr(257,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(257,0,257,0,0,"sub-sequence", 0, 2, 0);
	trans[0][257]	= settr(256,0,300,478,478,"LEG2CRM!20,17", 1, 3, 0);
	...
	trans[0][259]	= settr(258,0,261,479,479,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][262]	= settr(261,0,264,480,480,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][265]	= settr(264,0,267,481,481,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][268]	= settr(267,0,270,482,482,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][271]	= settr(270,0,70,483,483,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][274]	= settr(273,0,70,484,484,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][277]	= settr(276,0,70,485,485,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][280]	= settr(279,0,70,486,486,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][283]	= settr(282,0,70,487,487,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][286]	= settr(285,0,70,488,488,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][289]	= settr(288,0,853,489,489,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][292]	= settr(291,0,853,490,490,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][295]	= settr(294,0,853,491,491,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][297]	= settr(296,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][301]	= settr(300,0,302,492,0,"((((C1_bo.right==1)||(C1_bo.oblig==1))||(C1_bo.prohib==1)))", 1, 2, 0);
	trans[0][302]	= settr(301,0,304,493,493,"C1_bo.status = P", 1, 2, 0);
	T = trans[ 0][304] = settr(303,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(303,0,303,0,0,"sub-sequence", 0, 2, 0);
	trans[0][303]	= settr(302,0,346,494,494,"LEG2CRM!20,13", 1, 3, 0);
	...
	trans[0][305]	= settr(304,0,307,495,495,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][308]	= settr(307,0,310,496,496,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][311]	= settr(310,0,313,497,497,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][314]	= settr(313,0,316,498,498,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][317]	= settr(316,0,70,499,499,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][320]	= settr(319,0,70,500,500,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][323]	= settr(322,0,70,501,501,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][326]	= settr(325,0,70,502,502,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][329]	= settr(328,0,70,503,503,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][332]	= settr(331,0,70,504,504,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][335]	= settr(334,0,853,505,505,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][338]	= settr(337,0,853,506,506,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][341]	= settr(340,0,853,507,507,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][343]	= settr(342,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][347]	= settr(346,0,348,508,0,"((((C1_bo.right==1)||(C1_bo.oblig==1))||(C1_bo.prohib==1)))", 1, 2, 0);
	trans[0][348]	= settr(347,0,350,509,509,"C1_bo.status = TF", 1, 2, 0);
	T = trans[ 0][350] = settr(349,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(349,0,349,0,0,"sub-sequence", 0, 2, 0);
	trans[0][349]	= settr(348,0,392,510,510,"LEG2CRM!20,15", 1, 3, 0);
	...
	trans[0][351]	= settr(350,0,353,511,511,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][354]	= settr(353,0,356,512,512,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][357]	= settr(356,0,359,513,513,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][360]	= settr(359,0,362,514,514,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][363]	= settr(362,0,70,515,515,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][366]	= settr(365,0,70,516,516,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][369]	= settr(368,0,70,517,517,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][372]	= settr(371,0,70,518,518,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][375]	= settr(374,0,70,519,519,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][378]	= settr(377,0,70,520,520,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][381]	= settr(380,0,853,521,521,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][384]	= settr(383,0,853,522,522,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][387]	= settr(386,0,853,523,523,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][389]	= settr(388,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][393]	= settr(392,0,394,524,0,"((((C2_bo.right==1)||(C2_bo.oblig==1))||(C2_bo.prohib==1)))", 1, 2, 0);
	trans[0][394]	= settr(393,0,396,525,525,"C2_bo.status = S", 1, 2, 0);
	T = trans[ 0][396] = settr(395,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(395,0,395,0,0,"sub-sequence", 0, 2, 0);
	trans[0][395]	= settr(394,0,438,526,526,"LEG2CRM!21,17", 1, 3, 0);
	...
	trans[0][397]	= settr(396,0,399,527,527,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][400]	= settr(399,0,402,528,528,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][403]	= settr(402,0,405,529,529,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][406]	= settr(405,0,408,530,530,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][409]	= settr(408,0,70,531,531,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][412]	= settr(411,0,70,532,532,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][415]	= settr(414,0,70,533,533,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][418]	= settr(417,0,70,534,534,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][421]	= settr(420,0,70,535,535,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][424]	= settr(423,0,70,536,536,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][427]	= settr(426,0,853,537,537,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][430]	= settr(429,0,853,538,538,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][433]	= settr(432,0,853,539,539,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][435]	= settr(434,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][439]	= settr(438,0,440,540,0,"((((C2_bo.right==1)||(C2_bo.oblig==1))||(C2_bo.prohib==1)))", 1, 2, 0);
	trans[0][440]	= settr(439,0,442,541,541,"C2_bo.status = P", 1, 2, 0);
	T = trans[ 0][442] = settr(441,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(441,0,441,0,0,"sub-sequence", 0, 2, 0);
	trans[0][441]	= settr(440,0,484,542,542,"LEG2CRM!21,13", 1, 3, 0);
	...
	trans[0][443]	= settr(442,0,445,543,543,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][446]	= settr(445,0,448,544,544,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][449]	= settr(448,0,451,545,545,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][452]	= settr(451,0,454,546,546,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][455]	= settr(454,0,70,547,547,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][458]	= settr(457,0,70,548,548,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][461]	= settr(460,0,70,549,549,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][464]	= settr(463,0,70,550,550,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][467]	= settr(466,0,70,551,551,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][470]	= settr(469,0,70,552,552,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][473]	= settr(472,0,853,553,553,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][476]	= settr(475,0,853,554,554,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][479]	= settr(478,0,853,555,555,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][481]	= settr(480,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][485]	= settr(484,0,486,556,0,"((((C2_bo.right==1)||(C2_bo.oblig==1))||(C2_bo.prohib==1)))", 1, 2, 0);
	trans[0][486]	= settr(485,0,488,557,557,"C2_bo.status = TF", 1, 2, 0);
	T = trans[ 0][488] = settr(487,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(487,0,487,0,0,"sub-sequence", 0, 2, 0);
	trans[0][487]	= settr(486,0,530,558,558,"LEG2CRM!21,15", 1, 3, 0);
	...
	trans[0][489]	= settr(488,0,491,559,559,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][492]	= settr(491,0,494,560,560,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][495]	= settr(494,0,497,561,561,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][498]	= settr(497,0,500,562,562,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][501]	= settr(500,0,70,563,563,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][504]	= settr(503,0,70,564,564,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][507]	= settr(506,0,70,565,565,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][510]	= settr(509,0,70,566,566,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][513]	= settr(512,0,70,567,567,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][516]	= settr(515,0,70,568,568,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][519]	= settr(518,0,853,569,569,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][522]	= settr(521,0,853,570,570,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][525]	= settr(524,0,853,571,571,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][527]	= settr(526,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][531]	= settr(530,0,532,572,0,"((((C3_bo.right==1)||(C3_bo.oblig==1))||(C3_bo.prohib==1)))", 1, 2, 0);
	trans[0][532]	= settr(531,0,534,573,573,"C3_bo.status = S", 1, 2, 0);
	T = trans[ 0][534] = settr(533,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(533,0,533,0,0,"sub-sequence", 0, 2, 0);
	trans[0][533]	= settr(532,0,576,574,574,"LEG2CRM!22,17", 1, 3, 0);
	...
	trans[0][535]	= settr(534,0,537,575,575,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][538]	= settr(537,0,540,576,576,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][541]	= settr(540,0,543,577,577,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][544]	= settr(543,0,546,578,578,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][547]	= settr(546,0,70,579,579,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][550]	= settr(549,0,70,580,580,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][553]	= settr(552,0,70,581,581,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][556]	= settr(555,0,70,582,582,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][559]	= settr(558,0,70,583,583,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][562]	= settr(561,0,70,584,584,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][565]	= settr(564,0,853,585,585,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][568]	= settr(567,0,853,586,586,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][571]	= settr(570,0,853,587,587,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][573]	= settr(572,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][577]	= settr(576,0,578,588,0,"((((C3_bo.right==1)||(C3_bo.oblig==1))||(C3_bo.prohib==1)))", 1, 2, 0);
	trans[0][578]	= settr(577,0,580,589,589,"C3_bo.status = P", 1, 2, 0);
	T = trans[ 0][580] = settr(579,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(579,0,579,0,0,"sub-sequence", 0, 2, 0);
	trans[0][579]	= settr(578,0,622,590,590,"LEG2CRM!22,13", 1, 3, 0);
	...
	trans[0][581]	= settr(580,0,583,591,591,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][584]	= settr(583,0,586,592,592,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][587]	= settr(586,0,589,593,593,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][590]	= settr(589,0,592,594,594,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][593]	= settr(592,0,70,595,595,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][596]	= settr(595,0,70,596,596,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][599]	= settr(598,0,70,597,597,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][602]	= settr(601,0,70,598,598,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][605]	= settr(604,0,70,599,599,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][608]	= settr(607,0,70,600,600,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][611]	= settr(610,0,853,601,601,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][614]	= settr(613,0,853,602,602,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][617]	= settr(616,0,853,603,603,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][619]	= settr(618,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][623]	= settr(622,0,624,604,0,"((((C3_bo.right==1)||(C3_bo.oblig==1))||(C3_bo.prohib==1)))", 1, 2, 0);
	trans[0][624]	= settr(623,0,626,605,605,"C3_bo.status = TF", 1, 2, 0);
	T = trans[ 0][626] = settr(625,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(625,0,625,0,0,"sub-sequence", 0, 2, 0);
	trans[0][625]	= settr(624,0,668,606,606,"LEG2CRM!22,15", 1, 3, 0);
	...
	trans[0][627]	= settr(626,0,629,607,607,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][630]	= settr(629,0,632,608,608,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][633]	= settr(632,0,635,609,609,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][636]	= settr(635,0,638,610,610,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][639]	= settr(638,0,70,611,611,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][642]	= settr(641,0,70,612,612,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][645]	= settr(644,0,70,613,613,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][648]	= settr(647,0,70,614,614,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][651]	= settr(650,0,70,615,615,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][654]	= settr(653,0,70,616,616,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][657]	= settr(656,0,853,617,617,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][660]	= settr(659,0,853,618,618,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][663]	= settr(662,0,853,619,619,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][665]	= settr(664,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][669]	= settr(668,0,670,620,0,"((((ChooseAccept_bo.right==1)||(ChooseAccept_bo.oblig==1))||(ChooseAccept_bo.prohib==1)))", 1, 2, 0);
	trans[0][670]	= settr(669,0,672,621,621,"ChooseAccept_bo.status = S", 1, 2, 0);
	T = trans[ 0][672] = settr(671,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(671,0,671,0,0,"sub-sequence", 0, 2, 0);
	trans[0][671]	= settr(670,0,714,622,622,"LEG2CRM!23,17", 1, 3, 0);
	...
	trans[0][673]	= settr(672,0,675,623,623,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][676]	= settr(675,0,678,624,624,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][679]	= settr(678,0,681,625,625,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][682]	= settr(681,0,684,626,626,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][685]	= settr(684,0,70,627,627,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][688]	= settr(687,0,70,628,628,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][691]	= settr(690,0,70,629,629,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][694]	= settr(693,0,70,630,630,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][697]	= settr(696,0,70,631,631,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][700]	= settr(699,0,70,632,632,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][703]	= settr(702,0,853,633,633,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][706]	= settr(705,0,853,634,634,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][709]	= settr(708,0,853,635,635,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][711]	= settr(710,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][715]	= settr(714,0,716,636,0,"((((ChooseAccept_bo.right==1)||(ChooseAccept_bo.oblig==1))||(ChooseAccept_bo.prohib==1)))", 1, 2, 0);
	trans[0][716]	= settr(715,0,718,637,637,"ChooseAccept_bo.status = TF", 1, 2, 0);
	T = trans[ 0][718] = settr(717,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(717,0,717,0,0,"sub-sequence", 0, 2, 0);
	trans[0][717]	= settr(716,0,760,638,638,"LEG2CRM!23,15", 1, 3, 0);
	...
	trans[0][719]	= settr(718,0,721,639,639,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][722]	= settr(721,0,724,640,640,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][725]	= settr(724,0,727,641,641,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][728]	= settr(727,0,730,642,642,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][731]	= settr(730,0,70,643,643,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][734]	= settr(733,0,70,644,644,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][737]	= settr(736,0,70,645,645,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][740]	= settr(739,0,70,646,646,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][743]	= settr(742,0,70,647,647,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][746]	= settr(745,0,70,648,648,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][749]	= settr(748,0,853,649,649,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][752]	= settr(751,0,853,650,650,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][755]	= settr(754,0,853,651,651,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][757]	= settr(756,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][761]	= settr(760,0,762,652,0,"((((ChooseReject_bo.right==1)||(ChooseReject_bo.oblig==1))||(ChooseReject_bo.prohib==1)))", 1, 2, 0);
	trans[0][762]	= settr(761,0,764,653,653,"ChooseReject_bo.status = S", 1, 2, 0);
	T = trans[ 0][764] = settr(763,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(763,0,763,0,0,"sub-sequence", 0, 2, 0);
	trans[0][763]	= settr(762,0,806,654,654,"LEG2CRM!24,17", 1, 3, 0);
	...
	trans[0][765]	= settr(764,0,767,655,655,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][768]	= settr(767,0,770,656,656,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][771]	= settr(770,0,773,657,657,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][774]	= settr(773,0,776,658,658,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][777]	= settr(776,0,70,659,659,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][780]	= settr(779,0,70,660,660,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][783]	= settr(782,0,70,661,661,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][786]	= settr(785,0,70,662,662,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][789]	= settr(788,0,70,663,663,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][792]	= settr(791,0,70,664,664,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][795]	= settr(794,0,853,665,665,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][798]	= settr(797,0,853,666,666,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][801]	= settr(800,0,853,667,667,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][803]	= settr(802,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][807]	= settr(806,0,808,668,0,"((((ChooseReject_bo.right==1)||(ChooseReject_bo.oblig==1))||(ChooseReject_bo.prohib==1)))", 1, 2, 0);
	trans[0][808]	= settr(807,0,810,669,669,"ChooseReject_bo.status = TF", 1, 2, 0);
	T = trans[ 0][810] = settr(809,0,0,0,0,"sub-sequence", 0, 2, 0);
	T->nxt	= settr(809,0,809,0,0,"sub-sequence", 0, 2, 0);
	trans[0][809]	= settr(808,0,852,670,670,"LEG2CRM!24,15", 1, 3, 0);
	...
	trans[0][811]	= settr(810,0,813,671,671,"CRM2LEG?9,5", 1, 504, 0);
	...
	trans[0][814]	= settr(813,0,816,672,672,"CRM2LEG?8,5", 1, 504, 0);
	...
	trans[0][817]	= settr(816,0,819,673,673,"CRM2LEG?7,5", 1, 504, 0);
	...
	trans[0][820]	= settr(819,0,822,674,674,"CRM2LEG?6,5", 1, 504, 0);
	...
	trans[0][823]	= settr(822,0,70,675,675,"CRM2LEG?9,3", 1, 504, 0);
	...
	trans[0][826]	= settr(825,0,70,676,676,"CRM2LEG?8,3", 1, 504, 0);
	...
	trans[0][829]	= settr(828,0,70,677,677,"CRM2LEG?7,3", 1, 504, 0);
	...
	trans[0][832]	= settr(831,0,70,678,678,"CRM2LEG?9,1", 1, 504, 0);
	...
	trans[0][835]	= settr(834,0,70,679,679,"CRM2LEG?8,1", 1, 504, 0);
	...
	trans[0][838]	= settr(837,0,70,680,680,"CRM2LEG?7,1", 1, 504, 0);
	...
	trans[0][841]	= settr(840,0,853,681,681,"CRM2LEG?9,2", 1, 504, 0);
	...
	trans[0][844]	= settr(843,0,853,682,682,"CRM2LEG?8,2", 1, 504, 0);
	...
	trans[0][847]	= settr(846,0,853,683,683,"CRM2LEG?7,2", 1, 504, 0);
	trans[0][849]	= settr(848,0,853,1,0,"goto END_INIT", 0, 2, 0);
	trans[0][855]	= settr(854,0,856,1,0,"break", 0, 2, 0);
	trans[0][856]	= settr(855,0,0,684,684,"-end-", 0, 3500, 0);
	/* np_ demon: */

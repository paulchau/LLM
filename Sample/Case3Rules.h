...
RULE(CW1){
 ...
 ::EVENT(CW1,IS_P(CW1,STUDENT),P(CW1))
	->{
		printf("Prohibited action");
...
RULE(CW2){
 ...
 ::EVENT(CW2,IS_P(CW2,STUDENT),P(CW2))
	->{
		printf("Prohibited action");

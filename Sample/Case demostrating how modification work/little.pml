 ...
 *    working folder.
 * 3) rules.h in your working folder. (goodRules.h for successful implementation and badRules.h for assertion violated implementation)
 *
 * 4) Edit little.pml to comment 
 * and uncomment the rules file provided
 * in the code as needed. 
 *
 * 5) To run the code from Command Line type:
 * % spin -a little.pml
 * % cc -o pan pan.c
 * % pan -a
 *
...
proctype LEG()
{
  ...
  * For each of the 4 operations, 1 possible exec
  * are modelled: exec with S  */ 
 end:do
 :: L_E(STUDENT, a, S);
 :: L_E(STUDENT, b, S);  
 :: L_E(STUDENT, c, S);  

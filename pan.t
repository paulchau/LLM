...
{	Trans *T;
	...
	T = trans[ 3][3] = settr(1606,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(1606,2,1,0,0,"ATOMIC", 0, 2, 0);
	trans[3][1]	= settr(1604,0,6,3,3,"(!(ChooseAccept))", 0, 2, 0); /* m: 2 -> 6,0 */
	reached3[2] = 1;
	trans[3][2]	= settr(0,0,0,0,0,"assert(!(!(ChooseAccept)))",0,0,0);
